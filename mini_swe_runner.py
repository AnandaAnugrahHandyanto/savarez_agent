#!/usr/bin/env python3
"""
SWE Runner with Savarez Trajectory Format

A runner that uses Savarez-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Savarez-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Savarez-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Savarez format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Savarez-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Savarez-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Savarez Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Savarez-Agent's built-in execution environments
    and outputs trajectories in Savarez-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Savarez trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Savarez trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Savarez trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Savarez Trajectory Format")
    print("=" * 60)
