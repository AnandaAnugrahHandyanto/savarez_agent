...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin):
    ...
    def __init__(
        ...
        # it's shared across all Savarez processes for this HERMES_HOME.
    ...
    def _confirm_expensive_model_switch(self, result) -> bool:
        ...
        choices = [
            ("once", "Switch anyway", "Use this model for the current Savarez session."),
...
def main(
    ...
    if toolsets:
        ...
        # Coding posture (base Savarez): with no explicit --toolsets, collapse
