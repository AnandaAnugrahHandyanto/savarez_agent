...
# Add our tests at the end inside the TestAIAgent class
new_tests = """
...
# Let's insert it inside TestAIAgent but at the top so we don't mess up the indentation of the rest
content = content.replace("class TestAIAgent:\n", "class TestAIAgent:\n" + new_tests)
