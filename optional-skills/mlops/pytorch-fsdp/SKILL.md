...
The generated PyTorch distributed/FSDP quick reference was moved to `references/quick-reference.md` to keep this optional skill compact. Load that reference when detailed API excerpts are needed.
