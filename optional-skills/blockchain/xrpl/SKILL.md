---
name: xrpl
description: Query XRP Ledger data with USD pricing - account reserves, trust lines, recent transactions, ledger stats, fees, and transaction details. Uses public XRPL JSON-RPC + CoinGecko. No API key required.
version: 0.1.0
