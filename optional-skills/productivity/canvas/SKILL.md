...
4. Name the token (e.g., "Savarez AI Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.savarez/.env`:
...
```bash
CANVAS="python $SAVAREZ_HOME/skills/productivity/canvas/scripts/canvas_api.py"
