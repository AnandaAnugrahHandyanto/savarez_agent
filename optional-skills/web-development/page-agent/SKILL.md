...
- User wants **Savarez itself to drive a browser** → use Savarez' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
