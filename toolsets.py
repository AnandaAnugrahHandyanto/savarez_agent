...
TOOLSETS = {
    ...
    "hermes-google-chat": {
        "description": "Google Chat toolset - workspace messaging via Cloud Pub/Sub (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
