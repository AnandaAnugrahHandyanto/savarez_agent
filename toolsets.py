...
TOOLSETS = {
    ...
    "hermes-xmpp": {
        "description": "XMPP/Jabber bot toolset - federated open-protocol messaging via Prosody, ejabberd, or any XMPP server (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
