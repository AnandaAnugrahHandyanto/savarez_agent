...
TOOLSETS = {
    ...
    "hermes-google-chat": {
        "description": "Google Chat bot toolset - Google Workspace chat via Pub/Sub + Chat REST API",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
