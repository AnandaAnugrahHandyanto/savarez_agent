...
TOOLSETS = {
    ...
    "hermes-nostr": {
        "description": "Nostr bot toolset - decentralized encrypted messaging via Nostr relays",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
