...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `savarez tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "video_gen": {
        "description": (
            ...
            "``savarez tools`` → Video Generation."
        ),
    ...
    # Coding posture (base Savarez — CLI/TUI/desktop/ACP). Auto-selected in a
    ...
    # ==========================================================================
    # Full Savarez toolsets (CLI + messaging platforms)
    #
    ...
    "savarez-cron": {
        # Mirrors savarez-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `savarez tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as savarez-cli; gated by `savarez tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "savarez-email": {
        "description": "Email bot toolset - interact with Savarez via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "savarez-sms": {
        "description": "SMS bot toolset - interact with Savarez via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "savarez-gateway": {
        ...
        "tools": [],
        "includes": ["savarez-telegram", "savarez-discord", "savarez-whatsapp", "savarez-slack", "savarez-signal", "savarez-bluebubbles", "savarez-homeassistant", "savarez-email", "savarez-sms", "savarez-mattermost", "savarez-matrix", "savarez-dingtalk", "savarez-feishu", "savarez-wecom", "savarez-wecom-callback", "savarez-weixin", "savarez-qqbot", "savarez-webhook", "savarez-yuanbao"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (savarez-<name>).
        # Gives them _HERMES_CORE_TOOLS plus any tools the plugin registered
        # into a toolset matching the platform name.
        if name.startswith("savarez-"):
            platform_name = name[len("savarez-"):]
            try:
