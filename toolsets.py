...
TOOLSETS = {
    ...
    "hermes-kasia": {
        "description": "Kasia bot toolset - decentralized encrypted messaging platform (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-kasia", "hermes-homeassistant", "hermes-email", "hermes-sms"]
    }
}
