...
TOOLSETS = {
    ...
    "hermes-carbonvoice": {
        "description": "Carbon Voice toolset - voice-first messaging (STT/TTS) via Socket.IO + REST (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
