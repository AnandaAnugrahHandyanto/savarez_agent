...
_HERMES_CORE_TOOLS = [
    ...
    "browser_vision", "browser_console", "browser_cdp", "browser_cdp_harness", "browser_dialog",
    # Text-to-speech
    "text_to_speech",
    # Planning & memory
    "todo", "memory",
    ...
    # Hermes-native multi-agent team
    "team_run_task", "team_status", "team_events", "team_roles",
    "team_approvals", "team_approve", "team_reject", "team_metrics", "team_templates",
    # Cronjob management
    "cronjob",
...
TOOLSETS = {
    ...
    "browser": {
        ...
        "tools": [
            ...
            "browser_cdp_harness", "browser_dialog", "web_search"
        ],
        "includes": []
    },
    ...
    "team": {
        "description": "Hermes-native multi-agent team orchestration: run workflows, inspect status/events/roles, handle approvals, view metrics and templates",
        "tools": ["team_run_task", "team_status", "team_events", "team_roles", "team_approvals", "team_approve", "team_reject", "team_metrics", "team_templates"],
        "includes": []
    },
