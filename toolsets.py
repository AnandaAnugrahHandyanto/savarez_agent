...
_HERMES_CORE_TOOLS = [
    ...
    "vrchat_autonomy_enqueue_observation", "vrchat_autonomy_profile_status",
    "vrchat_autonomy_profile_tick", "vrchat_autonomy_heartbeat_tick",
    "vrchat_autonomy_run_turn", "vrchat_autonomy_loop_tick",
    "vrchat_autonomy_plan_turn", "vrchat_autonomy_prepare_profile",
    "vrchat_autonomy_conversation_dry_run",
    "vrchat_autonomy_wait_ready", "vrchat_autonomy_wait_then_tick",
    "vrchat_autonomy_runtime_doctor",
    # Neuro API-compatible VRChat bridge helpers (safe profile gate)
    "vrchat_neuro_status", "vrchat_neuro_build_messages", "vrchat_neuro_handle_action",
    # VRChat multimodal observation ingestion for autonomy loops
    "vrchat_observation_ingest", "vrchat_observation_from_osc", "vrchat_observation_queue_status",
    # VRChat private-instance smoke progression gate
    "vrchat_autonomy_prepare_private_smoke", "vrchat_autonomy_wait_then_private_smoke",
    "vrchat_autonomy_private_smoke",
    # VRChat live-smoke preflight evidence bundle
    "vrchat_autonomy_preflight_bundle", "vrchat_autonomy_completion_audit",
