...
TOOLSETS = {
    ...
    "hermes-bale": {
        "description": "Bale bot toolset - Telegram-compatible personal messaging with full access",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
