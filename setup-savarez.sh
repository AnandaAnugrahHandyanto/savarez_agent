...
# 5. Symlinks the 'savarez' CLI command into a user-facing bin dir
...
echo ""
echo -e "${CYAN}⚕ Savarez AI Agent Setup${NC}"
echo ""
...
if is_termux; then
    ...
    if [ -n "$UV_CMD" ]; then
        ...
        _uv_log="$(mktemp 2>/dev/null || echo "/tmp/savarez-uv-install.$$.log")"
...
# ============================================================================
# PATH setup — symlink savarez into a user-facing bin dir
# ============================================================================

echo -e "${CYAN}→${NC} Setting up savarez command..."

HERMES_BIN="$SCRIPT_DIR/venv/bin/savarez"
COMMAND_LINK_DIR="$(get_command_link_dir)"
COMMAND_LINK_DISPLAY_DIR="$(get_command_link_display_dir)"
mkdir -p "$COMMAND_LINK_DIR"
ln -sf "$HERMES_BIN" "$COMMAND_LINK_DIR/savarez"
echo -e "${GREEN}✓${NC} Symlinked savarez → $COMMAND_LINK_DISPLAY_DIR/savarez"
...
# ============================================================================
# Seed bundled skills into ~/.savarez/skills/
# ============================================================================

HERMES_SKILLS_DIR="${SAVAREZ_HOME:-$HOME/.savarez}/skills"
mkdir -p "$HERMES_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.savarez/skills/ ..."
...
echo "Other commands:"
echo "  savarez status        # Check configuration"
if is_termux; then
    echo "  savarez gateway       # Run gateway in foreground"
else
    echo "  savarez gateway install # Install gateway service (messaging + cron)"
fi
echo "  savarez cron list     # View scheduled jobs"
echo "  savarez doctor        # Diagnose issues"
echo ""
