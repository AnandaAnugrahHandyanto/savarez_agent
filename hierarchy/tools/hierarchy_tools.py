...
def send_to_profile(args: dict, **kwargs) -> str:
    ...
    # Validate priority
    from hierarchy.core.ipc.models import MessagePriority, MessageType
    try:
...
def org_chart_tool(args: dict, **kwargs) -> str:
    ...
    try:
        from hierarchy.core.registry.org_chart import render_org_chart
        registry = _get_profile_registry()
...
def profile_status(args: dict, **kwargs) -> str:
    ...
    if mem_store is not None:
        try:
            from hierarchy.core.memory.models import MemoryTier
...
def share_knowledge(args: dict, **kwargs) -> str:
    ...
    try:
        from hierarchy.core.memory.models import KnowledgeEntry, generate_knowledge_id
...
def read_ancestor_memory(args: dict, **kwargs) -> str:
    ...
    from hierarchy.core.memory.models import MemoryEntryType as _MET, MemoryTier as _MT
...
def get_chain_context(args: dict, **kwargs) -> str:
    ...
    from hierarchy.core.memory.models import MemoryTier as _MT
...
def check_hierarchy_requirements() -> bool:
    ...
    try:
        ...
        # Quick import check
        from hierarchy.core.registry.profile_registry import ProfileRegistry  # noqa: F401
        return True
    except ImportError:
        return False
    except Exception:
