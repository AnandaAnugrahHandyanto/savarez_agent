...
from hierarchy.core.workers.interface import WorkerManager
from hierarchy.core.workers.resume import ResumeContext
from hierarchy.core.workers.serialization import WorkerConfig
...
class WorkerBridge:
    ...
    def resume_worker(
        ...
        """
        from hierarchy.core.workers.resume import resume as _resume
