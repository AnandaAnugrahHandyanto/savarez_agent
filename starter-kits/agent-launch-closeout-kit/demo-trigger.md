...
1. Run the readiness pass:
   ...
   - or on macOS for one-command workspace priming + timed capture + finalize + verification: `bash starter-kits/agent-launch-closeout-kit/scripts/demo-capture-timed-record-wrapper.sh --prime-workspace`
