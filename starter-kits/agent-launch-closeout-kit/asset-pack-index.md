...
- Demo trigger card: `starter-kits/agent-launch-closeout-kit/demo-trigger.md`
...
- Demo timed-wrapper smoke test: `starter-kits/agent-launch-closeout-kit/scripts/verify-demo-capture-timed-record-wrapper.sh`
