...
def _get_cron_paths():
    """Dynamically resolve cron paths to respect active profile scopes."""
    cron_dir = get_hermes_home() / "cron"
    return cron_dir, cron_dir / "jobs.json", cron_dir / "output"
...
def ensure_dirs():
    ...
    cron_dir, _, output_dir = _get_cron_paths()
...
def save_job_output(job_id: str, output: str):
    ...
    ensure_dirs()
    _, _, output_dir = _get_cron_paths()
