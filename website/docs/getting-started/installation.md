...
**A virtual environment is strictly required.** Global or system-wide Python installations are not supported and will be actively blocked to prevent PEP 668 "externally managed environment" errors and dependency conflicts. Use only the official installers, Docker, or Nix.
