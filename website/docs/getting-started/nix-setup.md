...
nix run github:SIUNCT/hermes-agent -- setup
nix run github:SIUNCT/hermes-agent -- chat

# Or install persistently
nix profile install github:SIUNCT/hermes-agent
hermes setup
hermes chat
```
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:SIUNCT/hermes-agent";
  };
