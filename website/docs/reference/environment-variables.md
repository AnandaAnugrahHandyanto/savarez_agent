...
| `SPRITES_TOKEN` | Sprites: stateful Firecracker VM sandboxes on Fly.io ([sprites.dev](https://sprites.dev/)) |
| `SPRITES_BASE_URL` | Sprites API base URL (default: `https://api.sprites.dev`) |
