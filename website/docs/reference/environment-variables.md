...
| `DINFERENCE_API_KEY` | DInference API key ([dinference.com](https://dinference.com/)) |
| `DINFERENCE_BASE_URL` | Override DInference base URL (default: `https://api.dinference.com/v1`) |
