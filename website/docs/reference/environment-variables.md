...
| `FIREWORKS_API_KEY` | Fireworks AI API key ([fireworks.ai](https://fireworks.ai/)) |
| `FIREWORKS_BASE_URL` | Override Fireworks AI base URL (default: `https://api.fireworks.ai/inference/v1`) |
