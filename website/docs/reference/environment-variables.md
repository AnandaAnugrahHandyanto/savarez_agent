...
| `WAVESPEED_API_KEY` | WaveSpeed image generation backend ([wavespeed.ai](https://wavespeed.ai/accesskey)) |
| `WAVESPEED_API_BASE_URL` | Override the WaveSpeed image API base URL (default: `https://api.wavespeed.ai/api/v3`) |
