...
| Variable | Description |
|----------|-------------|
| `TERMINAL_ENV` | Backend: `local`, `docker`, `ssh`, `singularity`, `modal`, `e2b`, `daytona` |
...
| `TERMINAL_E2B_TEMPLATE` | E2B sandbox template |
...
## Container Resources (Docker, Singularity, Modal, E2B, Daytona)
