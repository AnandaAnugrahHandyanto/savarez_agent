...
| `ocr-and-documents` | Unified document and vision OCR processing center. Extract text from PDFs, scanned documents, and images. Use web_extract for HTML/simple PDFs, paddleocr for high-precision OCR and complex layouts (tables/formulas), pymupdf for fast local pure-text PDFs, and marker-pdf for offline high-privacy parsing. | `productivity/ocr-and-documents` |
