...
| [`media-delivery-prep`](/docs/user-guide/skills/bundled/media/media-media-delivery-prep) | Use when a user wants to send, convert, compress, inspect, trim, or prepare media attachments for Hermes messaging platforms. | `media/media-delivery-prep` |
