...
| [`hermes-delegation-personas`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-delegation-personas) | Use native Hermes delegate_task personas and bridge workers safely. Covers canonical persona providers, embedded vs bridge delegation, Claude/Cursor MCP wiring, and fallback-provider separation. | `autonomous-ai-agents/hermes-delegation-personas` |
