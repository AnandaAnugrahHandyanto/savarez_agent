...
| Skill | Description | Path |
|-------|-------------|------|
| [`code-wiki`](/user-guide/skills/bundled/software-development/software-development-code-wiki) | Generate wiki docs + Mermaid diagrams for any codebase. | `software-development/code-wiki` |
