...
| [`rocky-voice`](/docs/user-guide/skills/bundled/creative/creative-rocky-voice) | Use when the user activates Rocky mode, asks Hermes to speak as Rocky, wants Project Hail Mary / Eridian roleplay, or says to use Rocky voice. Persona skill: every user-visible response should be rendered in Rocky's voice until the user... | `creative/rocky-voice` |
