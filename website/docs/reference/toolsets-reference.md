...
| `hermes-a2a` | Same non-interactive coding/research set as `hermes-acp` (no messaging, audio, or clarify UI). Used by the A2A (Agent2Agent) server for task delegation by other agents. |
