...
| `/resume [name\|number]` | Resume a previously-named session — by title, session ID, or a position number from the recent-sessions list (`/resume 1` is the most recent named session, `/resume 2` the next, …). The bare `/resume` list is numbered to match. |
...
| `/resume [name\|number]` | Resume a previously named session — by title or a position number from the recent-sessions list (`/resume 1` = most recent named session, `/resume 2` the next, …). |
