...
- **Runs anywhere, not just your laptop** — 7 terminal backends: local, Docker, SSH, Singularity, Modal, Daytona, Vercel Sandbox. Daytona and Modal offer serverless persistence — your environment hibernates when idle, costing nearly nothing
- **Lives where you do** — CLI, Telegram, Discord, Slack, WhatsApp, Signal, Matrix, Mattermost, Email, SMS, DingTalk, Feishu, WeCom, BlueBubbles, Home Assistant — 21+ messaging platforms (19 in the gateway, plus IRC and Microsoft Teams via plugins)
