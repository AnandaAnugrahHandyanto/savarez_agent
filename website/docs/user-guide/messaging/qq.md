...
:::info
This adapter uses the **Official QQ Bot API v2** (`api.sgroup.qq.com`). This is distinct from unofficial OneBot 11 implementations. If you were previously using a OneBot 11 adapter, note that the environment variables and configuration have changed.
:::
