...
| | |
|---|---|
| Source | Optional — install with `savarez skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Savarez AI Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $HERMES_OSINT_CACHE/icij/ (default: ~/.cache/savarez-osint/icij/).
