...
description: "Public-records OSINT investigation framework — FEC campaign finance, SEC EDGAR filings, USAspending contracts, Senate lobbying, OFAC sanctions, ICIJ offshore..."
---
...
Public-records OSINT investigation framework — FEC campaign finance, SEC EDGAR filings, USAspending contracts, Senate lobbying, OFAC sanctions, ICIJ offshore leaks. Entity resolution across sources, cross-link analysis, timing correlation, evidence chains. Python stdlib only.
