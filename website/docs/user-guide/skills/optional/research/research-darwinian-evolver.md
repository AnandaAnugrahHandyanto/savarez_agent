...
| | |
|---|---|
| Source | Optional — install with `savarez skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Savarez AI Agent |
| License | MIT |
...
import upstream classes into Savarez itself.
...
Open `~/.savarez/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Savarez core.
   Custom driver scripts under `~/.savarez/skills/...` are user-side and fine.
