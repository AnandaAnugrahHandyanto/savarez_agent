...
| | |
|---|---|
| Source | Optional — install with `savarez skills install official/research/qmd` |
...
Savarez AI Agent via the native MCP client. This is the preferred
...
Then configure Savarez AI Agent to connect via HTTP:
