...
| | |
|---|---|
| Source | Optional — install with `savarez skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Savarez AI Agent |
| License | MIT |
...
```
SCRIPT=~/.savarez/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.savarez/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
