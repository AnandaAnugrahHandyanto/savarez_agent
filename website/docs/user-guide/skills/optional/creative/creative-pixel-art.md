...
| | |
|---|---|
| Source | Optional — install with `savarez skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.savarez/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.savarez/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Savarez installs package this)
