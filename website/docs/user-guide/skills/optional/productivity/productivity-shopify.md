...
| | |
|---|---|
| Source | Optional — install with `savarez skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Savarez","productType":"Apparel","tags":["test"]}}'
```
