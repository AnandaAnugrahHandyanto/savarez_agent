---
title: "Sudo From Secrets File"
sidebar_label: "Sudo From Secrets File"
description: "Use a local secrets file to supply sudo or other credentials during Hermes terminal tasks, with a Python subprocess fallback when shell piping to sudo behave..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Sudo From Secrets File

Use a local secrets file to supply sudo or other credentials during Hermes terminal tasks, with a Python subprocess fallback when shell piping to sudo behaves unexpectedly.
...
| Path | `skills/software-development/sudo-from-secrets-file` |
