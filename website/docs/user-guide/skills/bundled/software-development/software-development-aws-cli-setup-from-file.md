---
title: "Aws Cli Setup From File"
sidebar_label: "Aws Cli Setup From File"
...
# Aws Cli Setup From File

Install AWS CLI v2 and configure default credentials from a text file that stores the access key and secret on separate lines.
...
| Path | `skills/software-development/aws-cli-setup-from-file` |
