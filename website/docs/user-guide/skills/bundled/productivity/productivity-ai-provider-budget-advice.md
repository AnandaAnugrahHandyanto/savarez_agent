---
title: "Ai Provider Budget Advice"
sidebar_label: "Ai Provider Budget Advice"
...
Advise budget-conscious users choosing AI subscriptions, API credits, student/free plans, and Hermes-compatible provider spend.
...
| Path | `skills/productivity/ai-provider-budget-advice` |
| Version | `1.0.0` |
| Author | Mizuki |
| License | MIT |
