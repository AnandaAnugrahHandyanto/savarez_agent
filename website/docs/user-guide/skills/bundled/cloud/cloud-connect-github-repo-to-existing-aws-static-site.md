---
title: "Connect Github Repo To Existing Aws Static Site"
sidebar_label: "Connect Github Repo To Existing Aws Static Site"
description: "Connect an existing GitHub repository to an already-deployed S3 + CloudFront static website using GitHub Actions, including AWS credential repair, workflow r..."
---
...
Connect an existing GitHub repository to an already-deployed S3 + CloudFront static website using GitHub Actions, including AWS credential repair, workflow retargeting, repo secret/variable setup, and live verification.
...
| Path | `skills/cloud/connect-github-repo-to-existing-aws-static-site` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
