---
title: "Route53 Domain Transfer — Transfer an existing domain from another registrar to AWS Route 53 using the AWS CLI"
sidebar_label: "Route53 Domain Transfer"
...
Transfer an existing domain from another registrar to AWS Route 53 using the AWS CLI.
...
| Path | `skills/cloud/route53-domain-transfer` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
