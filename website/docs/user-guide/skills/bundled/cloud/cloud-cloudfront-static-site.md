---
title: "Cloudfront Static Site"
sidebar_label: "Cloudfront Static Site"
...
Provision an S3-backed static website served through CloudFront with Origin Access Control using AWS CLI.
...
| Path | `skills/cloud/cloudfront-static-site` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
