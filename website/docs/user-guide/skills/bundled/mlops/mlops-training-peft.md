...
| Path | `skills/mlops/training/peft` |
| Version | `1.0.0` |
...
- **[Advanced Usage](https://github.com/NousResearch/hermes-agent/blob/main/skills/mlops/training/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/NousResearch/hermes-agent/blob/main/skills/mlops/training/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
