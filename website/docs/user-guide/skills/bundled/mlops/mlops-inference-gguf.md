---
title: "Gguf Quantization — GGUF format and llama"
sidebar_label: "Gguf Quantization"
description: "GGUF format and llama"
---
...
| Path | `skills/mlops/inference/gguf` |
| Version | `1.0.0` |
...
- **[Advanced Usage](https://github.com/NousResearch/hermes-agent/blob/main/skills/mlops/inference/gguf/references/advanced-usage.md)** - Batching, speculative decoding, custom builds
- **[Troubleshooting](https://github.com/NousResearch/hermes-agent/blob/main/skills/mlops/inference/gguf/references/troubleshooting.md)** - Common issues, debugging, benchmarks
