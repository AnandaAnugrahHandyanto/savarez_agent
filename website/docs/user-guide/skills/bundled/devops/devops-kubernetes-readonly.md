...
description: "Run strictly read-only kubectl inspections (get, describe, explain, api-resources, version, cluster-info, top) with JSON I/O for agents"
---
...
Run strictly read-only kubectl inspections (get, describe, explain, api-resources, version, cluster-info, top) with JSON I/O for agents. Use when the user needs cluster visibility without mutating state.
