---
title: "Xitter — Interact with X/Twitter via the x-cli terminal client using official X API credentials"
sidebar_label: "Xitter"
description: "Interact with X/Twitter via the x-cli terminal client using official X API credentials"
---
...
| Path | `skills/social-media/xitter` |
| Version | `1.0.0` |
