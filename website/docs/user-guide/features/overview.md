...
- **[Subagent Delegation](delegation.md)** — The `delegate_task` tool spawns isolated child workers, either native API children or local Claude/Cursor bridge sessions. Run 3 concurrent children by default (configurable) for parallel workstreams.
