...
| **Nous Blue** (`nous-blue`) | Light cream canvas with vivid Nous-blue accents |
| **Catppuccin Mocha** (`catppuccin-mocha`) | Mocha dark base with pastel mauve, blue, pink, green, and yellow accents |
