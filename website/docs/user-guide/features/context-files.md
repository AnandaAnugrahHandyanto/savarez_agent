...
Savarez AI Agent automatically discovers and loads context files that shape how it behaves. Some are project-local and discovered from your working directory. `SOUL.md` is now global to the Hermes instance and is loaded from `SAVAREZ_HOME` only.
...
| **SOUL.md** | Global personality and tone customization for this Hermes instance | `SAVAREZ_HOME/SOUL.md` only |
...
- `~/.savarez/SOUL.md`
- or `$SAVAREZ_HOME/SOUL.md` if you run Hermes with a custom home directory

Important details:

- Hermes seeds a default `SOUL.md` automatically if one does not exist yet
- Hermes loads `SOUL.md` only from `SAVAREZ_HOME`
