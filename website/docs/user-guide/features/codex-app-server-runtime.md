...
If you find a bug, [open an issue](https://github.com/AnandaAnugrahHandyanto/savarez_agent/issues) with the output of `savarez logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
...
For implementation details, see [PR #24182](https://github.com/AnandaAnugrahHandyanto/savarez_agent/pull/24182) and the [Codex app-server protocol README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md).
