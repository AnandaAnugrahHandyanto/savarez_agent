...
| `catppuccin-mocha` | Catppuccin Mocha — soft pastel dark theme | `Hermes Agent` | Mocha base/crust surfaces with a vibrant full-palette MOTD: red/peach/yellow/green/sky/mauve block-logo rows, bold multi-color caduceus hero art, sky tool labels, green skills, yellow system accents, peach prompt, and matching status/completion/selection surfaces. |
