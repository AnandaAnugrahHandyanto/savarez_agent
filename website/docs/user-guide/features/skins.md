...
|------|-------------|----------------|------------------|
| `default` | Classic Hermes — gold and kawaii | `Savarez AI Agent` | Warm gold borders, cornsilk text, kawaii faces in spinners. The familiar caduceus banner. Clean and inviting. |
...
Hermes Mod respects the `SAVAREZ_HOME` environment variable, so it works with [profiles](/user-guide/profiles) too.
