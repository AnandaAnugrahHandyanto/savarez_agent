...
If you're writing the worker code itself — the agent that runs *inside* a lane — the [`kanban-worker`](https://github.com/AnandaAnugrahHandyanto/savarez_agent/blob/main/skills/devops/kanban-worker/SKILL.md) skill is the deeper procedural detail.
...
The [`kanban-worker`](https://github.com/AnandaAnugrahHandyanto/savarez_agent/blob/main/skills/devops/kanban-worker/SKILL.md) skill has worked examples for both `kanban_complete` (truly terminal tasks — typo fixes, docs changes, research writeups) and the `review-required` block pattern.
...
The historical issue for this is [#19931](https://github.com/AnandaAnugrahHandyanto/savarez_agent/issues/19931) and the closed-not-merged Codex-specific PR [#19924](https://github.com/AnandaAnugrahHandyanto/savarez_agent/pull/19924) — those describe the original architecture proposal but didn't land a runner.
...
- [`kanban-worker`](https://github.com/AnandaAnugrahHandyanto/savarez_agent/blob/main/skills/devops/kanban-worker/SKILL.md) — the skill the worker process loads.
- [`kanban-orchestrator`](https://github.com/AnandaAnugrahHandyanto/savarez_agent/blob/main/skills/devops/kanban-orchestrator/SKILL.md) — the orchestrator side.
