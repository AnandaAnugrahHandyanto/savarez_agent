...
:::info
The `browser` toolset must be included in your config's `toolsets` list or enabled via `savarez config set toolsets '["hermes-cli", "browser"]'`.
:::
