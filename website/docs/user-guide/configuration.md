...
For AI provider setup (OpenRouter, Anthropic, Cursor, Copilot, custom endpoints, self-hosted LLMs, fallback models, etc.), see [AI Providers](/integrations/providers).
