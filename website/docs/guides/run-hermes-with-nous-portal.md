...
If a model is genuinely unavailable, [open an issue](https://github.com/AnandaAnugrahHandyanto/savarez_agent/issues) — most gaps are routing config we can update.
