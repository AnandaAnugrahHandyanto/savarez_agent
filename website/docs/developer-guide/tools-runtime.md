...
Savarez tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. Savarez resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`savarez-cli`, `savarez-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `savarez-acp`
