              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-self-improvement-maintenance',
                ...
                },
                {
                  type: 'category',
                  label: 'cloud',
                  key: 'skills-bundled-cloud',
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/cloud/cloud-cloudfront-static-site',
                    'user-guide/skills/bundled/cloud/cloud-connect-github-repo-to-existing-aws-static-site',
                    'user-guide/skills/bundled/cloud/cloud-route53-domain-transfer',
                  ],
                },
                {
                  type: 'category',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/devops/devops-disk-cloning-and-migration',
                    'user-guide/skills/bundled/devops/devops-docker-on-ubuntu-24-from-apt',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/gaming/gaming-hearthstone-on-ubuntu',
                ...
                },
                {
                  type: 'category',
                  label: 'leisure',
                  key: 'skills-bundled-leisure',
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/leisure/leisure-find-nearby',
                  ],
                },
                {
                  type: 'category',
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/mcp/mcp-mcporter',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/mlops/mlops-models-clip',
                    'user-guide/skills/bundled/mlops/mlops-research-dspy',
                    'user-guide/skills/bundled/mlops/mlops-inference-gguf',
                    'user-guide/skills/bundled/mlops/mlops-training-grpo-rl-training',
                    'user-guide/skills/bundled/mlops/mlops-inference-guidance',
                    ...
                    'user-guide/skills/bundled/mlops/mlops-cloud-modal',
                    'user-guide/skills/bundled/mlops/mlops-inference-obliteratus',
                    'user-guide/skills/bundled/mlops/mlops-inference-outlines',
                    'user-guide/skills/bundled/mlops/mlops-training-peft',
                    'user-guide/skills/bundled/mlops/mlops-training-pytorch-fsdp',
                    'user-guide/skills/bundled/mlops/mlops-models-segment-anything',
                    'user-guide/skills/bundled/mlops/mlops-models-stable-diffusion',
                    ...
                    'user-guide/skills/bundled/mlops/mlops-models-whisper',
                  ],
                },
                {
                  type: 'category',
                  label: 'mlops-cloud',
                  key: 'skills-bundled-mlops-cloud',
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/mlops-cloud/mlops-cloud-self-hosted-llm-gpu-cloud-deployments',
                  ],
                },
                {
                  type: 'category',
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/note-taking/note-taking-study-roadmap-progress-tracking',
                  ],
                },
                {
                  type: 'category',
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/productivity/productivity-ai-provider-budget-advice',
                    'user-guide/skills/bundled/productivity/productivity-airtable',
                    'user-guide/skills/bundled/productivity/productivity-cv-pdf-and-image-generator',
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/research/research-ddg-html-price-research-fallback',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/social-media/social-media-xitter',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-android-development-on-ubuntu',
                    'user-guide/skills/bundled/software-development/software-development-aws-cli-setup-from-file',
                    'user-guide/skills/bundled/software-development/software-development-debugging-hermes-tui-commands',
                    'user-guide/skills/bundled/software-development/software-development-ecommerce-webapp-upgrades',
                    ...
                    'user-guide/skills/bundled/software-development/software-development-komorebi-on-ubuntu-24',
                    ...
                    'user-guide/skills/bundled/software-development/software-development-project-based-technical-mentoring',
                    ...
                    'user-guide/skills/bundled/software-development/software-development-sudo-from-secrets-file',
                    ...
                    'user-guide/skills/bundled/software-development/software-development-ubuntu-premium-zsh-setup',
                    'user-guide/skills/bundled/software-development/software-development-writing-plans',
                    'user-guide/skills/bundled/software-development/software-development-x11-desktop-automation',
                    'user-guide/skills/bundled/software-development/software-development-x11-desktop-helpers-mizuki',
                    'user-guide/skills/bundled/software-development/software-development-zsh-oh-my-zsh-ubuntu',
                  ],
                },
                {
                  type: 'category',
