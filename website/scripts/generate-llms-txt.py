#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Savarez docs site.
...
Both publish at:
  https://savarez-agent.nousresearch.com/docs/llms.txt
  https://savarez-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://savarez-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Savarez as a Python Library", None),
        ("guides/use-mcp-with-savarez", "Use MCP with Savarez", None),
        ("guides/use-voice-mode-with-savarez", "Use Voice Mode with Savarez", None),
        ("guides/use-soul-with-savarez", "Use SOUL.md with Savarez", None),
        ("guides/build-a-savarez-plugin", "Build a Savarez Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Savarez"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/AnandaAnugrahHandyanto/"
        "savarez-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/AnandaAnugrahHandyanto/savarez_agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Savarez AI Agent — Full Documentation\n",
        (
            "This file is the entire Savarez AI Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Savarez, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://savarez-agent.nousresearch.com/docs\n",
        "Short index: https://savarez-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
