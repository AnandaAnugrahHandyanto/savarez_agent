...
Dashboard 内置九个主题，并可通过用户自定义主题、插件标签页和后端 API 路由进行扩展——全部即插即用，无需克隆仓库。
...
| **Nous Blue** (`nous-blue`) | 浅色奶油画布，配鲜明的 Nous-blue 点缀 |
| **Catppuccin Mocha** (`catppuccin-mocha`) | Mocha 暗色底色，配粉彩 mauve、blue、pink、green 和 yellow 点缀 |
