...
| **Nous Blue**（`nous-blue`） | 浅色奶油画布 + 鲜明 Nous-blue 点缀 | Inter + JetBrains Mono，15px | 0.5rem 圆角，comfortable |
| **Catppuccin Mocha**（`catppuccin-mocha`） | Mocha base/mantle/crust + 粉彩 mauve/blue/pink 点缀 | Inter + JetBrains Mono，15px | 0.85rem 圆角，comfortable |
