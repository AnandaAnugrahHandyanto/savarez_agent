...
| 皮肤 | 描述 | Agent 品牌 | 视觉特征 |
|------|------|-----------|---------|
| `default` | 经典 Hermes — 金色与 kawaii 风格 | `Savarez AI Agent` | 暖金色边框，cornsilk 文字，spinner 中的 kawaii 面孔。熟悉的双蛇杖横幅。简洁亲切。 |
...
Hermes Mod 遵循 `SAVAREZ_HOME` 环境变量，因此也适用于[配置文件](/user-guide/profiles)。
