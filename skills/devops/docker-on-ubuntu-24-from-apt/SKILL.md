---
name: docker-on-ubuntu-24-from-apt
description: Install Docker Engine, Compose v2, and Buildx on Ubuntu 24.04 using apt, with sudo credentials loaded from ~/.config/mizuki/secrets.env when needed.
---
