---
name: disk-cloning-and-migration
description: Safely prepare and run SSD/HDD disk cloning or system migration on Linux, with source/target identification, health checks, ddrescue safeguards, and post-clone expansion.
version: 1.0.0
author: Mizuki
license: MIT
metadata:
