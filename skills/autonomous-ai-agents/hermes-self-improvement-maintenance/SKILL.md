---
name: hermes-self-improvement-maintenance
description: "Quiet, non-destructive Hermes Agent self-improvement and maintenance for a user environment: audit health, apply reusable lessons to memory/skills, and avoid noisy or risky changes."
version: 1.0.0
author: Mizuki
license: MIT
metadata:
