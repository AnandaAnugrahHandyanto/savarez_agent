...
metadata:
  hermes:
    tags: [music, audio, transcription, lyrics, lrc, whisper, acestep]
    related_skills: [acestep, acestep-songwriting, acestep-simplemv, acestep-thumbnail, acestep-docs, heartmula]
---
