...
metadata:
  hermes:
    tags: [music, documentation, troubleshooting, installation, acestep]
    related_skills: [acestep, acestep-songwriting, acestep-lyrics-transcription, acestep-simplemv, acestep-thumbnail, heartmula]
---
