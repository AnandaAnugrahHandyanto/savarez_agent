...
metadata:
  hermes:
    tags: [music, image, thumbnail, album-art, gemini, acestep]
    related_skills: [acestep, acestep-songwriting, acestep-lyrics-transcription, acestep-simplemv, acestep-docs, heartmula]
---
