...
metadata:
  hermes:
    tags: [music, audio, generation, ai, acestep, text-to-music, lyrics, songs, remix]
    related_skills: [acestep-songwriting, acestep-lyrics-transcription, acestep-simplemv, acestep-thumbnail, acestep-docs, heartmula]
---
