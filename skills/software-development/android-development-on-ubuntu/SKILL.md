---
name: android-development-on-ubuntu
description: Use when setting up or repairing an Android or Android TV Kotlin development environment on Ubuntu Linux, including Java, Android Studio, SDK tools, emulator, Gradle, ADB, environment variables, and verification.
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    ...
    related_skills: [sudo-from-secrets-file, x11-desktop-automation]
---
