---
name: zsh-oh-my-zsh-ubuntu
description: Install and configure Zsh with Oh My Zsh, fzf, zsh-autosuggestions, and zsh-syntax-highlighting on Ubuntu; set Zsh as default shell and verify interactive key bindings.
---
