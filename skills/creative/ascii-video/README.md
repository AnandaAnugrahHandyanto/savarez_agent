...
Built for [Hermes Agent](https://github.com/SIUNCT/hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`SIUNCT/hermes-agent/skills/creative/ascii-video`](https://github.com/SIUNCT/hermes-agent/tree/main/skills/creative/ascii-video) via PR.
