...
version: 1.0.0
author: Savarez AI Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md)
license: MIT
...
Each template includes a **Savarez Implementation Notes** block at the top with:
