...
## Reviewer Evaluation Criteria and Common Issues

Detailed reviewer evaluation criteria, common issue remediation, and template pointers were moved to `references/reviewer-criteria-and-common-issues.md` to keep `SKILL.md` below the active skill size limit.

See also `references/reference-documents.md` for detailed templates.
