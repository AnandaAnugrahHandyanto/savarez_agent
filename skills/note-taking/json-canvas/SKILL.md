...
Use this skill when the task is specifically about `.canvas` files or visual Obsidian canvases. For broad vault work, use `obsidian`; for regular Markdown notes, use `obsidian-markdown`.
