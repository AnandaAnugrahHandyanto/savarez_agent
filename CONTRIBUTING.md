...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [Nous Research Discord](https://discord.gg/SIUNCT). Users can install it with `hermes skills install`.
...
- **Discord**: [discord.gg/SIUNCT](https://discord.gg/SIUNCT) — for questions, showcasing projects, and sharing skills
