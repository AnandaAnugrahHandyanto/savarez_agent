...
def filter_tool_definitions_by_name(
    ...
    allowed_tool_names: list[str] | set[str] | tuple[str, ...] | None,
) -> list[dict[str, Any]]:
    """Return only tool definitions whose function name is in *allowed_tool_names*."""
...
def get_tool_definitions(
    ...
    Args:
        ...
        enabled_tools: Further restrict the final tool list to these tool names.
    ...
    if enabled_tools is not None:
        filtered_tools = filter_tool_definitions_by_name(filtered_tools, enabled_tools)
