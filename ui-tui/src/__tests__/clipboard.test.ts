...
import { isUsableClipboardText, readClipboardText, readPrimarySelectionText, writeClipboardText } from '../lib/clipboard.js'
...
describe('readPrimarySelectionText', () => {
  it('reads Linux PRIMARY selection from wl-paste before clipboard backends', async () => {
