    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            if isinstance(telegram_cfg, dict):
                ...
                if "group_reactions" in telegram_cfg and not os.getenv("TELEGRAM_GROUP_REACTIONS"):
                    os.environ["TELEGRAM_GROUP_REACTIONS"] = str(telegram_cfg["group_reactions"]).lower()
