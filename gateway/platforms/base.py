...
class BasePlatformAdapter(ABC):
    ...
    def build_source(
        ...
        chat_details: Optional[str] = None,
        ...
        return SessionSource(
            ...
            chat_details=chat_details.strip() if chat_details else None,
            pinned_messages=pinned_messages,
            prior_thread_context=prior_thread_context.strip() if prior_thread_context else None,
