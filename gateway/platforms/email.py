"""
Email platform adapter for the Savarez gateway.

Allows users to interact with Savarez by sending emails.
...
def _send_imap_id(imap: "imaplib.IMAP4") -> None:
    ...
    try:
        ...
        imap.xatom(
            "ID",
            f'("name" "savarez-agent" "version" "{_hermes_version}" '
            '"vendor" "AnandaAnugrahHandyanto" '
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Savarez AI Agent")
        ...
        msg_id = f"<savarez-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
