...
Config: ~/.savarez/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.savarez/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hermes_home()`` helper (SAVAREZ_HOME-aware and
