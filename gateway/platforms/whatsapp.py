...
class WhatsAppAdapter(BasePlatformAdapter):
    ...
    def _should_process_message(self, data: Dict[str, Any]) -> bool:
        ...
        # Exception: Status updates may be opted into via the statuses
        # configuration (ingest=true) when the WhatsApp status primitives
        # are enabled.
        is_status = any(
        ...
        if is_status:
            ...
            if not (
                ...
                return False
        elif self._is_broadcast_chat(chat_id_raw):
            return False
