...
try:
    ...
    _SDK_PROCESS_IS_ASYNC = _inspect.iscoroutinefunction(_process_method) if _process_method else False
    _SDK_START_IS_ASYNC = _inspect.iscoroutinefunction(_start_method) if _start_method else False
