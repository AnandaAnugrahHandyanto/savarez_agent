...
index. ``scripts/telegram/send_rich.py`` (the cron sender) writes the same
file format with an inlined copy of ``record`` since it can't import this
package; keep the two in sync if the format changes.
