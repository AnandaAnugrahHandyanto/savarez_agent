...
class GatewaySlashCommandsMixin:
    ...
    def _typed_command_prefix_for(self, platform) -> str:
        """Return the prefix users can always type to reach Savarez commands.
    ...
    async def _handle_version_command(self, event: MessageEvent) -> str:
        """Handle /version — show the running Savarez version."""
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        """Handle /update command — update Savarez to the latest version.
        ...
        if is_managed():
            return f"✗ {format_managed_message('update Savarez')}"
