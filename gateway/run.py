...
class GatewayRunner:
    ...
    def _create_adapter(
        ...
        if platform == Platform.TELEGRAM:
            ...
            if not check_qqbot_requirements():
                logger.warning("QQBot: qq-botpy not installed or QQBOT_APPID/QQBOT_TOKEN not set. Run: uv add qq-botpy")
                return None
    ...
    def _is_user_authorized(self, source: SessionSource) -> bool:
        ...
        platform_env_map = {
            ...
            Platform.QQBOT: "QQBOT_ALLOWED_USERS",
        }
        platform_allow_all_map = {
            ...
            Platform.QQBOT: "QQBOT_ALLOW_ALL_USERS",
        }
