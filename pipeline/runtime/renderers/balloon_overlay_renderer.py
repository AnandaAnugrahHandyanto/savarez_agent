...
CANONICAL_LIB = Path(__file__).resolve().parents[1] / "lib"
if str(CANONICAL_LIB) not in sys.path:
    sys.path.insert(0, str(CANONICAL_LIB))
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="render_balloons.py",
        description="Render balloon/caption overlays from analysis guidance.",
    )
