...
- Snapshot persisted at `~/.savarez/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.savarez/plugins/hermes-achievements/scan_checkpoint.json`.
