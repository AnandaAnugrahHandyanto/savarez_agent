# Savarez Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.savarez/plugins/savarez-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.savarez/plugins/savarez-achievements/scan_checkpoint.json`.
