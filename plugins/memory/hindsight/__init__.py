...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        if mode == "cloud":
            ...
            # Preserve an existing key when the operator leaves the prompt
            # blank.  The embedded daemon consumes HINDSIGHT_API_LLM_API_KEY
            # from its profile env; materializing it from an intentionally
            # blank prompt would erase a working local setup.
