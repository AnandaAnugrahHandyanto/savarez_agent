"""ntfy platform adapter (Savarez plugin).
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "savarez-in"              # subscribe topic (incoming)
          publish_topic: "savarez-out"     # optional — defaults to topic
...
_ECHO_TAG = "savarez-agent"  # tag added to outgoing messages for echo-loop prevention
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Savarez dependency",
