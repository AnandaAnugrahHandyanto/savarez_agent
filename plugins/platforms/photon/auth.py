...
Credential storage mirrors every other Savarez channel:
...
# registers Savarez as its own client_id.
...
# Default name of the project Savarez provisions for the operator.
...
def _auth_json_path() -> Path:
    """Resolve ``~/.hermes/auth.json`` honouring the active Savarez profile."""
    try:
