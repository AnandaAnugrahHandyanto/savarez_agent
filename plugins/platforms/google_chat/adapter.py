...
def interactive_setup() -> None:
    ...
    print_info("  4. On the TOPIC: add the per-project Chat API SA as Pub/Sub Publisher (shown in")
    print_info("     Chat API → Configuration → Connection settings; do NOT use the generic")
    print_info("     chat-api-push@system.gserviceaccount.com — it is no longer authorized).")
