...
session-scoped state file under ``$SAVAREZ_HOME/workspace/meetings/.active.json``
...
# File + directory layout (under $SAVAREZ_HOME):
#
#   workspace/meetings/
...
def start(
    ...
    *,
    ...
    If a bot is already running for this savarez install, leave it first —
