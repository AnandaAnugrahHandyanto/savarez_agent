...
class TestDeliverResultWrapping:
    ...
    def test_delivery_failure_framing_no_double_wrap(self):
        """Failed jobs get a single ⚠️ failure header, not a 'failed' line nested
        inside the success 'Cronjob Response' header."""
        from gateway.config import Platform
        ...
        assert "Cron job '" not in sent_content
