...
_HERMES_BEHAVIORAL_VARS = frozenset({
    ...
    # Transcript capture rollout gates/paths — live Stage B env values must
    # never leak into hermetic unit tests.
    "HERMES_TRANSCRIPT_RUNTIME_ROOT",
    "HERMES_TRANSCRIPT_ACTIVE_DIR",
    "HERMES_TRANSCRIPT_CORPUS_DIR",
    "HERMES_TRANSCRIPT_STATE_DIR",
    ...
    "HERMES_TRANSCRIPT_PLATFORM_ALLOWLIST",
    "HERMES_TRANSCRIPT_SESSION_ALLOWLIST",
    "HERMES_TRANSCRIPT_CHAT_ALLOWLIST",
    "HERMES_TRANSCRIPT_DENYLIST",
    "HERMES_TRANSCRIPT_PROCESSING_MODEL",
    "HERMES_TRANSCRIPT_MAX_ARTIFACT_AGE_DAYS",
})
