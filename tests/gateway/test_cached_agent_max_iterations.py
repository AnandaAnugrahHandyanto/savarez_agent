...
def mock_gateway():
    ...
    # Need the real _init_cached_agent_for_turn method
    from gateway.run import GatewayRunner as RealGatewayRunner
    runner._init_cached_agent_for_turn = RealGatewayRunner._init_cached_agent_for_turn.__func__
