...
class TestFeishuMentionMap(unittest.TestCase):
    def test_build_mentions_map_handles_at_all(self):
        from hermes_agent.gateway.platforms.feishu import _build_mentions_map, _FeishuBotIdentity, FeishuMentionRef
    ...
    def test_build_mentions_map_marks_self_by_open_id(self):
        from hermes_agent.gateway.platforms.feishu import _build_mentions_map, _FeishuBotIdentity
...
class TestFeishuMentionHint(unittest.TestCase):
    def test_hint_single_user(self):
        from hermes_agent.gateway.platforms.feishu import FeishuMentionRef, _build_mention_hint
    ...
    def test_hint_returns_empty_for_no_refs(self):
        from hermes_agent.gateway.platforms.feishu import _build_mention_hint
...
class TestFeishuStripLeadingSelf(unittest.TestCase):
    def _make_refs(self, *, self_name="Hermes", other_name=None):
        from hermes_agent.gateway.platforms.feishu import FeishuMentionRef
    ...
    def test_strips_leading_self(self):
        from hermes_agent.gateway.platforms.feishu import _strip_edge_self_mentions
    ...
    def test_returns_input_when_no_self_refs(self):
        from hermes_agent.gateway.platforms.feishu import _strip_edge_self_mentions, FeishuMentionRef
...
class TestFeishuNormalizeText(unittest.TestCase):
    def test_renders_mention_with_display_name(self):
        from hermes_agent.gateway.platforms.feishu import _normalize_feishu_text, FeishuMentionRef
    ...
    def test_at_all_rendered_as_english_literal(self):
        from hermes_agent.gateway.platforms.feishu import _normalize_feishu_text
...
class TestFeishuPostMentionParsing(unittest.TestCase):
    def test_post_at_tag_renders_via_mentions_map(self):
        ...
        from hermes_agent.gateway.platforms.feishu import parse_feishu_post_payload, FeishuMentionRef
    ...
    def test_post_at_tag_falls_back_to_inline_user_name_when_map_misses(self):
        ...
        from hermes_agent.gateway.platforms.feishu import parse_feishu_post_payload
...
class TestFeishuNormalizeWithMentions(unittest.TestCase):
    def test_text_message_renders_mention_by_name(self):
        from hermes_agent.gateway.platforms.feishu import normalize_feishu_message, _FeishuBotIdentity
