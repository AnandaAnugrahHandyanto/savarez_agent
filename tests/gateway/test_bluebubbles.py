...
class TestBlueBubblesWebhookUrl:
    """_webhook_url property pins local hosts to IPv4 loopback."""

    def test_default_host(self, monkeypatch):
        adapter = _make_adapter(monkeypatch)
        # Default webhook_host is 127.0.0.1 and must stay IPv4; BlueBubbles
        # can resolve localhost to ::1 while Hermes binds IPv4 only.
