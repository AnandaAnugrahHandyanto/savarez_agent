...
def store(tmp_path, monkeypatch):
    ...
    ~/.savarez/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at hermes_state import time, before pytest's SAVAREZ_HOME monkeypatch
    fires — the autouse fixture's SAVAREZ_HOME override doesn't help here.)
    """
    import hermes_state
