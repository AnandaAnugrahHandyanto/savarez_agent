...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/AnandaAnugrahHandyanto/savarez_agent/issues/23994:
    reply_to_mode 'off' was ignored when sending via Savarez-created DM topic
