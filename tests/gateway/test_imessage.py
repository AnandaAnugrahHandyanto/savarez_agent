...
class TestIMessageRedaction:
    ...
    def test_api_key_in_env_assignment_redacted(self):
        from agent.redact import redact_sensitive_text
        result = redact_sensitive_text("IMESSAGE_API_KEY=qzUf8DEmUqcN2cexP5WuGaFj")
        assert "qzUf8DEmUqcN2cexP5WuGaFj" not in result

    def test_bearer_token_redacted(self):
        from agent.redact import redact_sensitive_text
        result = redact_sensitive_text("Authorization: Bearer aHR0cHM6Ly81cWtqdXAuaW1zZ2QucGhvdG9uLmNvZHMvfHF6VWY4REVtVXFjTjJjZXhQNVd1R2FGag==")
        assert "aHR0cHM6Ly81cWtqdXAuaW1zZ2QucGhvdG9uLmNvZHMvfHF6VWY4REVtVXFjTjJjZXhQNVd1R2FGag==" not in result
