...
@pytest.mark.asyncio
async def test_discord_free_response_channel_auto_threads_when_enabled(adapter, monkeypatch):
    """Free-response channels can accept mention-free messages and still auto-thread."""
    monkeypatch.setenv("DISCORD_REQUIRE_MENTION", "true")
