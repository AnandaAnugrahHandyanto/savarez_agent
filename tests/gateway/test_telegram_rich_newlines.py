...
# Mock telegram package if not installed (same pattern as test_telegram_format.py).
if "telegram" not in sys.modules or not hasattr(sys.modules.get("telegram", None), "__file__"):
    mod = MagicMock()
