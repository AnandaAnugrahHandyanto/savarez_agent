...
class TestLoadGatewayConfig:
    ...
    def test_bridges_discord_approval_ping_users_from_config_yaml(self, tmp_path, monkeypatch):
        hermes_home = tmp_path / ".hermes"
        hermes_home.mkdir()
        config_path = hermes_home / "config.yaml"
        config_path.write_text(
            "discord:\n"
            "  approval_ping_users: allowed_users\n",
            encoding="utf-8",
        )
        ...
        assert discord_extra["approval_ping_users"] == "allowed_users"
        assert os.environ["DISCORD_APPROVAL_PING_USERS"] == "allowed_users"
