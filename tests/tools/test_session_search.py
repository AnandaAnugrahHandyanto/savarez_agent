...
from hermes_agent.tools.session_search_tool import (
    _format_timestamp,
...
class TestSessionSearchConcurrency:
    ...
    def test_session_search_respects_configured_concurrency_limit(self, monkeypatch):
        ...
        from hermes_agent.tools.session_search_tool import session_search
...
class TestSessionSearch:
    ...
    def test_current_session_excluded_keeps_others(self):
        ...
        with _patch("hermes_agent.tools.session_search_tool.async_call_llm",
