...
class TestExecuteCode(unittest.TestCase):
    ...
    def _run(self, code, enabled_tools=None):
        ...
        with patch("hermes_agent.backends.model_tools.handle_function_call", side_effect=_mock_handle_function_call):
            result = execute_code(
                code=code,
                task_id="test-task",
...
class TestEnvVarFiltering(unittest.TestCase):
    ...
    def _get_child_env(self, extra_env=None):
        ...
        try:
            ...
            with patch("hermes_agent.backends.model_tools.handle_function_call", return_value='{}'), \
