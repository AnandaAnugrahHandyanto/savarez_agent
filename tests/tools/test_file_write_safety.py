...
class TestCheckSensitivePathMacOSBypass:
    ...
    def test_macos_user_temp_path_allowed(self):
        from tools.file_tools import _check_sensitive_path
        assert _check_sensitive_path("/private/var/folders/zz/hermes-test/file.txt") is None
        assert _check_sensitive_path("/var/folders/zz/hermes-test/file.txt") is None
