...
# ---------------------------------------------------------------------------
# Pinned-skill guard — pinned skills are deletion-protected.
# Edits/patches/writes are allowed; delete/remove_file require unpin.
# ---------------------------------------------------------------------------

class TestPinnedGuard:
    """Pinned skills block destructive deletes but still allow maintenance."""
    ...
    def test_edit_allows_pinned(self, tmp_path):
        with _skill_dir(tmp_path):
            _create_skill("my-skill", VALID_SKILL_CONTENT)
    ...
    def test_patch_allows_pinned(self, tmp_path):
        with _skill_dir(tmp_path):
            _create_skill("my-skill", VALID_SKILL_CONTENT)
            with self._pin("my-skill"):
                result = _patch_skill("my-skill", "Do the thing.", "Do the new thing.")
    ...
    def test_patch_supporting_file_allows_pinned(self, tmp_path):
        with _skill_dir(tmp_path):
            _create_skill("my-skill", VALID_SKILL_CONTENT)
    ...
    def test_write_file_allows_pinned(self, tmp_path):
        with _skill_dir(tmp_path):
            _create_skill("my-skill", VALID_SKILL_CONTENT)
            with self._pin("my-skill"):
    ...
    def test_unpinned_skills_still_editable(self, tmp_path):
        ...
        Only destructive operations are refused; normal edits should still work.
        """
        with _skill_dir(tmp_path):
