...
class TestTTSProviderNullGuard:
    ...
    def test_explicit_null_provider_returns_default(self):
        ...
        from hermes_agent.tools.tts_tool import _get_provider, DEFAULT_PROVIDER
    ...
    def test_valid_provider_passed_through(self):
        from hermes_agent.tools.tts_tool import _get_provider
...
class TestWebBackendNullGuard:
    ...
    @patch("hermes_agent.tools.web_tools._load_web_config", return_value={"backend": None})
    ...
    @patch("hermes_agent.tools.web_tools._load_web_config", return_value={})
...
class TestTrajectoryCompressorNullGuard:
    ...
    def test_null_base_url_does_not_crash(self):
        ...
        from hermes_agent.providers.trajectory_compressor import CompressionConfig, TrajectoryCompressor
    ...
    def test_config_loading_null_base_url_keeps_default(self):
        ...
        from hermes_agent.providers.trajectory_compressor import CompressionConfig
