...
class TestWebSearchErrorHandling:
    ...
    def test_search_error_response_does_not_expose_diagnostics(self):
        ...
        with patch("hermes_agent.tools.web_tools._get_backend", return_value="firecrawl"), \
             patch("hermes_agent.tools.web_tools._get_firecrawl_client", return_value=firecrawl_client), \
