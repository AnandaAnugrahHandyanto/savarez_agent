...
class TestPerCapabilityBackendSelection:
    ...
    def test_search_backend_accepts_xai_override(self, monkeypatch):
        from tools import web_tools
        ...
        assert web_tools._get_search_backend() == "xai"

    def test_search_only_backend_does_not_enable_extract(self, monkeypatch):
        from tools import web_tools
