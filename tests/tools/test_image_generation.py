...
class TestRegistryIntegration:
    ...
    def test_schema_exposes_prompt_aspect_ratio_and_optional_routing_hints(self, image_tool):
        """The agent-facing schema exposes prompt/aspect_ratio plus optional
        per-call routing hints for providers that support model aliases."""
