...
_ISSUER = "https://auth.example.com/application/o/savarez"
_CLIENT_ID = "savarez-dashboard"
...
class TestStartLogin:
    ...
    def test_returns_login_start(self, provider):
        result = provider.start_login(
            redirect_uri="https:/.savarez.example/auth/callback"
        )
    ...
    def test_authorize_url_has_required_params(self, provider):
        ...
        assert params["redirect_uri"] == "https:/.savarez.example/auth/callback"
    ...
    def test_two_calls_differ(self, provider):
        a = provider.start_login(redirect_uri="https:/.savarez.example/auth/callback")
        b = provider.start_login(redirect_uri="https:/.savarez.example/auth/callback")
        assert (
