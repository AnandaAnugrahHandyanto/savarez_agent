"""Tests for the savarez-tools-as-MCP server module surface.
...
class TestModuleSurface:
    ...
    def test_expected_hermes_specific_tools_listed(self):
        """The Savarez-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `savarez chat -q` subprocesses; if they
