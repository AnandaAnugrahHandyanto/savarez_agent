"""Tests for CodexEventProjector — codex item/* events → Savarez messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Savarez' message alternation invariant."""
