...
def test_normalize_lang_accepts_aliases():
    ...
    assert i18n._normalize_lang("Indonesian") == "id"
    assert i18n._normalize_lang("Bahasa Indonesia") == "id"
    assert i18n._normalize_lang("id-ID") == "id"
...
def test_t_explicit_lang():
    ...
    assert i18n.t("approval.denied", lang="id").endswith("Ditolak")
