"""Tests for MiniMax provider hardening — context lengths, max output, thinking guard."""
import pytest
...
class TestMinimaxMaxOutput:
    """Verify per-model max output token lookup."""

    def test_m1_base_output(self):
        from agent.model_metadata import get_minimax_max_output
        assert get_minimax_max_output("MiniMax-M1") == 81_920

    def test_m1_40k_output(self):
        from agent.model_metadata import get_minimax_max_output
        assert get_minimax_max_output("MiniMax-M1-40k") == 40_960

    def test_m1_80k_output(self):
        from agent.model_metadata import get_minimax_max_output
        assert get_minimax_max_output("MiniMax-M1-80k") == 81_920

    def test_m1_128k_output(self):
        from agent.model_metadata import get_minimax_max_output
        assert get_minimax_max_output("MiniMax-M1-128k") == 131_072

    def test_m1_256k_output(self):
        from agent.model_metadata import get_minimax_max_output
        assert get_minimax_max_output("MiniMax-M1-256k") == 262_144

    def test_m25_output(self):
        from agent.model_metadata import get_minimax_max_output
        assert get_minimax_max_output("MiniMax-M2.5") == 131_072

    def test_m27_output(self):
        from agent.model_metadata import get_minimax_max_output
        assert get_minimax_max_output("MiniMax-M2.7") == 131_072

    def test_unknown_model_default(self):
        from agent.model_metadata import get_minimax_max_output
        assert get_minimax_max_output("MiniMax-M99") == 131_072
