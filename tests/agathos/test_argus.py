...
# Tests moved to tests/agathos/ - use direct package imports
...
class TestAgathosConfiguration(unittest.TestCase):
...
class TestAgathosRestart(unittest.TestCase):
...
class TestAgathosKill(unittest.TestCase):
...
class TestAgathosPromptInjection(unittest.TestCase):
...
class TestAgathosTelegramNotification(unittest.TestCase):
...
class TestAgathosCollectMetrics(unittest.TestCase):
...
class TestAgathosConfigFile(unittest.TestCase):
    ...
    def test_load_config_from_hermes_config(self, mock_load):
        """Config must load from hermes config.yaml 'agathos' key."""
    ...
    def test_load_config_preserves_defaults_for_missing_keys(self, mock_load):
        ...
        mock_load.return_value = {"agathos": {"poll_interval": 45}}
...
class TestAgathosSandboxedCron(unittest.TestCase):
