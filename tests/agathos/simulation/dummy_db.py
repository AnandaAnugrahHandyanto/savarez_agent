...
DUMMY_DB_PATH = Path(__file__).parent / "dummy_agathos.db"
# tests/agathos/simulation/ -> tests/agathos/ -> tests/ -> hermes-dev/ -> argus/
SCHEMA_PATH = Path(__file__).parent.parent.parent.parent / "agathos" / "watcher_schema.sql"
