...
class TestWebServerEndpoints:
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from hermes_agent.cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_bad_token(self, tmp_path):
        ...
        from hermes_agent.cli.config import save_env_value
        from hermes_agent.cli.web_server import _SESSION_HEADER_NAME
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from hermes_agent.cli.web_server import _normalise_theme_definition
...
class TestDiscoverUserThemes:
    ...
    def test_returns_empty_when_dir_missing(self, tmp_path, monkeypatch):
        ...
        from hermes_agent.cli import web_server
