...
class TestApplyProfileOverrideSavarezHomeGuard:
    ...
    def test_subcommand_profile_flag_is_not_consumed(self, tmp_path, monkeypatch):
        ...
        profile pre-parser must not interpret the Docker profile as a Savarez
        profile.
        """
    ...
    def test_profile_after_chat_subcommand_is_still_consumed(self, tmp_path, monkeypatch):
        """Profile flags historically work after normal Savarez subcommands."""
        result = _run_apply_profile_override(
            tmp_path,
            monkeypatch,
            hermes_home=None,
