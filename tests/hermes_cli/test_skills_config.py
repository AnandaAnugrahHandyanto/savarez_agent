...
class TestSaveDisabledSkills:
    @patch("hermes_agent.cli.skills_config.save_config")
    def test_saves_global_sorted(self, mock_save):
        from hermes_agent.cli.skills_config import save_disabled_skills
        config = {}
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from hermes_agent.cli.skills_config import _get_categories
        skills = [
