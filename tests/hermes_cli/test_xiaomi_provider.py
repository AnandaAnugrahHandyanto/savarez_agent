...
class TestXiaomiAutoDetection:
    ...
    def test_auto_detect(self, monkeypatch):
        ...
        for var in ("OPENROUTER_API_KEY", "FASTROUTER_API_KEY", "OPENAI_API_KEY",
                     "ANTHROPIC_API_KEY", "DEEPSEEK_API_KEY", "GOOGLE_API_KEY",
                     "GEMINI_API_KEY", "DASHSCOPE_API_KEY", "XAI_API_KEY",
                     "KIMI_API_KEY", "MINIMAX_API_KEY", "AI_GATEWAY_API_KEY",
                     "KILOCODE_API_KEY", "HF_TOKEN", "GLM_API_KEY",
