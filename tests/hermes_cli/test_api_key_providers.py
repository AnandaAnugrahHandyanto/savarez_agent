...
class TestProviderRegistry:
    ...
    @pytest.mark.parametrize("provider_id,name,auth_type", [
        ...
        ("flock", "FLock API Platform", "api_key"),
    ])
    ...
    def test_flock_env_vars(self):
        pconfig = PROVIDER_REGISTRY["flock"]
        assert pconfig.api_key_env_vars == ("FLOCK_API_KEY",)
        assert pconfig.base_url_env_var == "FLOCK_BASE_URL"
        assert pconfig.inference_base_url == "https://api.flock.io/v1"
    ...
    def test_base_urls(self):
        ...
        assert PROVIDER_REGISTRY["flock"].inference_base_url == "https://api.flock.io/v1"
