...
from hermes_agent.cli.copilot_auth import _try_gh_cli_token
...
class TestHasAnyProviderConfigured:
    ...
    def test_glm_key_counts(self, monkeypatch, tmp_path):
        from hermes_agent.cli import config as config_module
...
class TestKimiMoonshotModelListIsolation:
    ...
    def test_moonshot_list_excludes_coding_plan_only_models(self):
        from hermes_agent.cli.main import _PROVIDER_MODELS
...
class TestHuggingFaceModels:
    ...
    def test_model_lists_match(self):
        ...
        from hermes_agent.cli.main import _PROVIDER_MODELS as main_models
        from hermes_agent.cli.models import _PROVIDER_MODELS as models_models
