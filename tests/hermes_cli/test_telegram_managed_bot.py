...
class TestGenerateDeepLink:
    ...
    def test_name_url_encoded(self):
        link = generate_deep_link(
            ...
            suggested_name="Savarez & Friends",
        )
        assert "Savarez+%26+Friends" in link
...
class TestCreatePairing:
    def test_success(self):
        ...
        mock_resp.json.return_value = {
            ...
            "deep_link": "https://t.me/newbot/SavarezSetupBot/hermes_abcdefghijklmnop_bot?name=Savarez+Agent",
            "qr_payload": "https://t.me/newbot/SavarezSetupBot/hermes_abcdefghijklmnop_bot?name=Savarez+Agent",
        ...
        with patch(
            ...
            pairing = create_pairing("https://api.example.com", bot_name="Savarez Agent")
...
class TestPollForToken:
    def pairing(self):
        return TelegramPairing(
            ...
            poll_token="secret-token",
            suggested_username="hermes_abcdefghijklmnop_bot",
            deep_link="https://t.me/newbot/SavarezSetupBot/hermes_abcdefghijklmnop_bot",
            qr_payload="https://t.me/newbot/SavarezSetupBot/hermes_abcdefghijklmnop_bot",
        )
