...
class TestApply:
    ...
    def test_enable_succeeds_when_codex_present(self):
        ...
        # Path.home() / ".codex" using whatever SAVAREZ_HOME the running pytest
        ...
        assert "via MCP" in r.message  # savarez-tools callback message
        assert cfg["model"]["openai_runtime"] == "codex_app_server"
    ...
    def test_enable_triggers_mcp_migration(self):
        """Enabling codex_app_server should auto-migrate Savarez mcp_servers
        ...
        with patch.object(crs, "check_codex_binary_ok",
            ...
            mig.return_value.migrated = ["filesystem", "savarez-tools"]
        ...
        # User MCP servers are reported (excluding internal savarez-tools)
        ...
        # Savarez tool callback announcement
