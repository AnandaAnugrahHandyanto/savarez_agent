"""ARGUS Circuit Breaker — automatic provider disable on failure.

Integrates with Hermes config.yaml to dynamically manage provider_routing.
Uses Argus provider_health for failure detection.
...
logger = logging.getLogger("argus.circuit_breaker")
