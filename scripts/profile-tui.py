#!/usr/bin/env python3
"""Drive the Savarez TUI under HERMES_DEV_PERF and summarize the pipeline.
...
~30 Hz (matching xterm key-repeat), summarizes ~/.savarez/perf.log on exit.
...
Environment overrides:
  HERMES_PERF_LOG     (default ~/.savarez/perf.log)
...
def loop_mode(args: argparse.Namespace) -> int:
    ...
    pkg_root = tui_dir / "packages" / "savarez-ink" / "src"
