...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Savarez\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "savarez@nousresearch.com",
    "savarez-audit@example.com",
    "savarez@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "AnandaAnugrahHandyanto/savarez-agent",
                "--state", "merged",
