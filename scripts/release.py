#!/usr/bin/env python3
"""Savarez AI Agent Release Script
...
AUTHOR_MAP = {
    ...
    "savarez@marian.local": "Schrotti77",
    ...
    "274096618+savarez-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "savarez@nousresearch.com": "AnandaAnugrahHandyanto",
    ...
    "savarez@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "teknium@savarez-agent": "teknium1",
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (SAVAREZ_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: savarez-eval community link)
    ...
    "vigo@savarez": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.savarez@agentmail.to": "oseftg",
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Savarez runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level SAVAREZ_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Savarez
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"savarez-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "savarez@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/AnandaAnugrahHandyanto/savarez_agent",
    ...
    lines.append(f"# Savarez AI Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Savarez AI Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Savarez AI Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Savarez AI Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Savarez AI Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Savarez AI Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Savarez AI Agent v{new_version} ({calver_date})' "
