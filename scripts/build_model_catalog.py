#!/usr/bin/env python3
"""Build the Savarez Model Catalog — a centralized JSON manifest of curated models.
...
Savarez CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Savarez release.
...
# Ensure SAVAREZ_HOME is set for imports that touch it at module level.
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "savarez-agent repo",
            "docs": "https://savarez-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
