...
DEFAULT_DATASETS = [
    ...
    "NousResearch/savarez-agent-megascience-sft1",
    "NousResearch/Savarez-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Savarez-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-savarez-agent"
]
