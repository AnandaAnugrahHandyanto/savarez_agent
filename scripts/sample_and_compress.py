...
DEFAULT_DATASETS = [
    "SIUNCT/swe-terminus-agent-glm-kimi-minimax",
    "SIUNCT/hermes-agent-megascience-sft1",
    "SIUNCT/Hermes-Agent-Thinking-GLM-4.7-SFT2",
    "SIUNCT/Hermes-Agent-Thinking-GLM-4.7-SFT1",
    "SIUNCT/terminal-tasks-glm-hermes-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "SIUNCT/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload SIUNCT/{output_name} {final_output}")
