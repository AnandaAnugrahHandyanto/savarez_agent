...
DEFAULT_DATASETS = [
    "AnandaAnugrahHandyanto/swe-terminus-agent-glm-kimi-minimax",
    "AnandaAnugrahHandyanto/savarez-agent-megascience-sft1",
    "AnandaAnugrahHandyanto/Savarez-Agent-Thinking-GLM-4.7-SFT2",
    "AnandaAnugrahHandyanto/Savarez-Agent-Thinking-GLM-4.7-SFT1",
    "AnandaAnugrahHandyanto/terminal-tasks-glm-savarez-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "AnandaAnugrahHandyanto/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload AnandaAnugrahHandyanto/{output_name} {final_output}")
