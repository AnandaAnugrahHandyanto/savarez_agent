...
from hermes_agent.agent.memory_manager import build_memory_context_block, sanitize_context
...
from hermes_agent.agent.prompt_builder import build_skills_system_prompt, build_context_files_prompt, build_environment_hints, load_soul_md, TOOL_USE_ENFORCEMENT_GUIDANCE, TOOL_USE_ENFORCEMENT_MODELS, GOOGLE_MODEL_OPERATIONAL_GUIDANCE, OPENAI_MODEL_EXECUTION_GUIDANCE
...
from hermes_agent.providers.utils import atomic_json_write, base_url_host_matches, base_url_hostname, env_var_enabled, normalize_proxy_url
...
class AIAgent:
    ...
    def __init__(
        ...
        from hermes_agent.providers.hermes_logging import setup_logging, setup_verbose_logging
    ...
    def _try_refresh_anthropic_client_credentials(self) -> bool:
        ...
        try:
            from hermes_agent.agent.anthropic_adapter import resolve_anthropic_token, build_anthropic_client
    ...
    def _apply_client_headers_for_base_url(self, base_url: str) -> None:
        from hermes_agent.agent.auxiliary_client import _AI_GATEWAY_HEADERS, _OR_HEADERS
    ...
    def _swap_credential(self, entry) -> None:
        ...
        if self.api_mode == "anthropic_messages":
            from hermes_agent.agent.anthropic_adapter import build_anthropic_client, _is_oauth_token
    ...
    def flush_memories(self, messages: list = None, min_turns: int = None):
        ...
        try:
            ...
            if not _aux_available and self.api_mode == "codex_responses":
                ...
                from hermes_agent.agent.auxiliary_client import _get_task_timeout
    ...
    def run_conversation(
        ...
        from hermes_agent.providers.hermes_logging import set_session_context
            ...
            while retry_count < max_retries:
                ...
                try:
                    ...
                    if (
                        ...
                        try:
                            from hermes_agent.agent.nous_rate_guard import record_nous_rate_limit
