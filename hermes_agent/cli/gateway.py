...
from hermes_agent.cli.setup import (
...
from hermes_agent.providers.hermes_constants import is_container, is_termux, is_wsl
...
def _setup_dingtalk():
    ...
    if method == 0:
        ...
        try:
            from hermes_agent.cli.dingtalk_auth import dingtalk_qr_auth
