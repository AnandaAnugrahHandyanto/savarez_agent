...
def _has_any_provider_configured() -> bool:
    ...
    from hermes_agent.cli.auth import get_auth_status
...
def cmd_chat(args):
    ...
    try:
        from hermes_agent.cli.banner import prefetch_update_check
...
def cmd_setup(args):
    ...
    from hermes_agent.cli.setup import run_setup_wizard
...
def select_provider_and_model(args=None):
    ...
    from hermes_agent.cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _aux_flow_provider_model(
    ...
    from hermes_agent.cli.auth import _prompt_model_selection
    from hermes_agent.cli.models import get_pricing_for_provider
...
def _prompt_provider_choice(choices, *, default=0):
    ...
    """
    try:
        from hermes_agent.cli.setup import _curses_prompt_choice
...
def _model_flow_openrouter(config, current_model=""):
    ...
    from hermes_agent.cli.models import model_ids, get_pricing_for_provider
...
def _model_flow_ai_gateway(config, current_model=""):
    ...
    from hermes_agent.cli.models import ai_gateway_model_ids, get_pricing_for_provider
...
def _model_flow_nous(config, current_model="", args=None):
    ...
    if free_tier and not model_ids:
        ...
        if unavailable_models:
            from hermes_agent.cli.auth import DEFAULT_NOUS_PORTAL_URL
...
def _model_flow_qwen_oauth(_config, current_model=""):
    ...
    from hermes_agent.cli.models import fetch_api_models
...
def _model_flow_custom(config):
    ...
    """
    from hermes_agent.cli.auth import _save_model_choice, deactivate_provider
    ...
    from hermes_agent.cli.models import probe_api_models
...
def _model_flow_copilot(config, current_model=""):
    ...
    if not api_key:
        ...
        if choice == "1":
            try:
                from hermes_agent.cli.copilot_auth import copilot_device_code_login
            ...
            # Validate token type
            try:
                from hermes_agent.cli.copilot_auth import validate_copilot_token
...
def _model_flow_stepfun(config, current_model=""):
    ...
    from hermes_agent.cli.config import get_env_value, save_env_value, load_config, save_config
    from hermes_agent.cli.models import fetch_api_models
...
def cmd_login(args):
    ...
    from hermes_agent.cli.auth import login_command
...
def cmd_logout(args):
    ...
    from hermes_agent.cli.auth import logout_command
...
def cmd_auth(args):
    ...
    from hermes_agent.cli.auth_commands import auth_command
...
def cmd_version(args):
    ...
    try:
        from hermes_agent.cli.banner import check_for_updates
...
def cmd_completion(args, parser=None):
    ...
    from hermes_agent.cli.completion import generate_bash, generate_zsh, generate_fish
