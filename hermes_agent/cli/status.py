...
from hermes_agent.cli.auth import AuthError, resolve_provider
...
from hermes_agent.cli.models import provider_label
...
def show_status(args):
    ...
    try:
        from hermes_agent.cli.auth import get_nous_auth_status, get_codex_auth_status, get_qwen_auth_status
