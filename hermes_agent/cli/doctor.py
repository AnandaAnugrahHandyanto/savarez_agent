...
def run_doctor(args):
    ...
    if config_path.exists():
        ...
        try:
            ...
            try:
                ...
                pass
            try:
                from hermes_agent.cli.auth import resolve_provider as _resolve_provider
            except Exception:
            ...
            if canonical_provider and canonical_provider not in ("auto", "custom", "openrouter"):
                try:
                    from hermes_agent.cli.auth import PROVIDER_REGISTRY, get_auth_status
    ...
    from hermes_agent.cli.auth import get_anthropic_key
