...
async def _start_device_code_flow(provider_id: str) -> Dict[str, Any]:
    ...
    from hermes_agent.cli import auth as hauth
    if provider_id == "nous":
        from hermes_agent.cli.auth import _request_device_code, PROVIDER_REGISTRY
        import httpx
...
def _nous_poller(session_id: str) -> None:
    ...
    from hermes_agent.cli.auth import _poll_for_token, refresh_nous_oauth_from_state
