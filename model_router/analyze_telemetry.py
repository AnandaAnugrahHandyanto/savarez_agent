        ...
        joined.append(
            {
                ...
                "mode": safe_get(decision_event, "input", "mode"),
                "priority": safe_get(decision_event, "input", "priority"),
                "privacy": safe_get(decision_event, "input", "privacy"),
                "quota": safe_get(decision_event, "input", "quota"),
                "speed": safe_get(decision_event, "input", "speed"),
                "has_code": safe_get(decision_event, "input", "has_code"),
                "has_logs": safe_get(decision_event, "input", "has_logs"),
