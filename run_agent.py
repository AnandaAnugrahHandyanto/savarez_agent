...
class AIAgent:
    ...
    def run_conversation(
        ...
        # Prevent the OS from sleeping while the agent loop runs.
        # Released in the finally block below — fires even on errors/interrupts.
        _stay_awake = StayAwake(enabled=self._stay_awake)
        _stay_awake.__enter__()
        try:
            ...
            _stay_awake.__exit__(None, None, None)
