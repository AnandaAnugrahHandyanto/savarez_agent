...
class AIAgent:
    ...
    def __init__(
        ...
        enable_memory_provider_tools: bool = False,
        memory_provider_agent_context: str = "primary",
        session_db=None,
        ...
        init_agent(
            ...
            enable_memory_provider_tools=enable_memory_provider_tools,
            memory_provider_agent_context=memory_provider_agent_context,
