...
class AIAgent:
    ...
    _SKILL_REVIEW_PROMPT = (
        ...
        "Scope: DO NOT modify bundled or hub-installed skills. Those are "
        "managed upstream; skill_manage will refuse writes against them. "
        "If a lesson belongs in territory covered by a bundled/hub skill, "
        "fork it into a new local skill name first, or record the lesson "
        "on an agent-created umbrella instead.\n\n"
