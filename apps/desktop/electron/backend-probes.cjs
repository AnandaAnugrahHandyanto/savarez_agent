 ...
 * resolveSavarezBackend (main.cjs). The resolver walks a ladder of
 ...
 *     not surfaced to the user, just to recentSavarezLog for forensics
 ...
 * rung of resolveSavarezBackend. Without this, a system Python 3.11-3.13
 ...
 * @returns {boolean}
 */
function canImportSavarezCli(pythonPath) {
 ...
 *   in resolveSavarezBackend.
 * @returns {boolean}
 */
function verifySavarezCli(hermesCommand, opts = {}) {
