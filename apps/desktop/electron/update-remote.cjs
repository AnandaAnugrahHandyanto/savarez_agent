 ...
 *
 * A public install can end up with `origin=git@github.com:AnandaAnugrahHandyanto/savarez_agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/AnandaAnugrahHandyanto/savarez_agent.git'
