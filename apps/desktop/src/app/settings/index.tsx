...
import { getSavarezConfigDefaults, getSavarezConfigRecord, saveSavarezConfig } from '@/hermes'
...
export function SettingsView({ gateway, onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getSavarezConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await saveSavarezConfig(await getSavarezConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {
