import type { SavarezConfigRecord, ToolsetInfo } from '@/types/hermes'
...
export function getNested(obj: SavarezConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: SavarezConfigRecord, path: string, value: unknown): SavarezConfigRecord {
...
function personalityOptions(config: SavarezConfigRecord): string[] {
