...
import type { SavarezConnection } from '@/global'
...
export const $connection = atom<SavarezConnection | null>(null)
...
export const setConnection = (next: Updater<SavarezConnection | null>) => updateAtom($connection, next)
