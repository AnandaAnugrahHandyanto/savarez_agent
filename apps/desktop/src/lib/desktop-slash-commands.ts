...
/** Why a known Savarez command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Savarez profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Savarez Agent version', surface: exec() },
