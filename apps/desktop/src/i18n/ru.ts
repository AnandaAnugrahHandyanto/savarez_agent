...
export const ru = defineLocale({
  ...
  install: {
    ...
    failedDesc: 'Один из шагов установки не удался. Остановите другие экземпляры Hermes и повторите.',
    activeDesc: 'Это одноразовая установка. Установщик загружает зависимости.',
