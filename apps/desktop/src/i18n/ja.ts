...
export const ja = defineLocale({
  ...
  rightSidebar: {
    ...
    dropPanelHere: 'ここにパネルをドロップ',
    resizePanelSplit: 'パネル分割のサイズを変更',
    refreshChanges: 'ソース管理を更新',
    sourceControlUnavailable: 'ソース管理を利用できません',
    notGitRepository: 'Git リポジトリではありません',
    notGitRepositoryBody: '現在のフォルダーは Git リポジトリ内にありません。',
    noChanges: '変更はありません',
    noChangesBody: '作業ツリーはクリーンです。',
    mergeChanges: 'マージ変更',
