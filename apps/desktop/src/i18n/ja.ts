...
export const ja = defineLocale({
  ...
  shell: {
    ...
    modelOptions: {
      ...
      effort: '努力度',
      minimal: '最小',
      minimalDescription: '推論を最小限にして最速で応答します。',
      low: '低',
      lowDescription: '軽い推論で素早く回答します。',
      medium: '中',
      mediumDescription: 'ほとんどのプロンプトに適したバランスのよい推論です。',
      high: '高',
      highDescription: '複雑な作業向けに、より深く推論します。',
      max: '最大',
      maxDescription: '対応している場合、最大の推論深度を使用します。',
