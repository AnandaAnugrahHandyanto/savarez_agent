...
export const ja = defineLocale({
  ...
  rightSidebar: {
    ...
    loadingChanges: 'ワークスペースの変更を読み込み中',
    changesLoadFailed: 'ワークスペースの変更を読み込めませんでした',
    changesNoProjectTitle: 'プロジェクトなし',
    changesNoProjectBody: 'Git の変更を見るには作業ディレクトリを設定してください。',
    changesNotGitTitle: 'Git リポジトリではありません',
    changesNotGitBody: 'このワークスペースは Git リポジトリ内にありません。',
    changesCleanTitle: 'クリーンなワークスペース',
    changesCleanBody: 'HEAD 以降のローカル変更はありません。',
    changedFiles: 'ファイル',
    addedLines: '追加',
    removedLines: '削除',
    binaryDiff: 'バイナリファイル — 行単位の diff は利用できません。',
    untrackedDiff: '未追跡ファイル — Git に追加すると行単位の diff を表示できます。',
    noDiffPreview: 'このファイルの行単位 diff プレビューはありません。',
    sessionChanges: 'セッションの変更',
    changesNoSessionTitle: 'アクティブなセッションがありません',
    changesNoSessionBody: 'チャットセッションを開くか続行すると、ターンごとのファイル変更を確認できます。',
    changedTurns: 'ターン',
    filesChangedInline: 'ファイル',
