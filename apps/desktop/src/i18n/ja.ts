...
export const ja = defineLocale({
  ...
  install: {
    ...
    connectExistingDesc:
      '2 つ目のローカル Hermes をインストールする代わりに、このデスクトップアプリを実行中のリモート Hermes dashboard に接続します。',
    remoteUrlLabel: 'リモート dashboard URL',
    remoteUrlPlaceholder: 'https://your-hermes-host.example.com',
    remoteTokenLabel: 'セッショントークン',
    remoteTokenPlaceholder: 'dashboard のセッショントークンを貼り付け',
    remoteProbeIdle: 'リモート dashboard URL を入力して認証方式を検出します。',
    remoteProbeChecking: 'リモート gateway を確認中…',
    remoteProbeFailed: 'その Hermes dashboard にはまだ到達できません。',
    remoteProbeOauth: 'この gateway はブラウザサインインを使います。',
    remoteProbeToken: 'この gateway にはセッショントークンが必要です。',
    remoteSignIn: 'リモート gateway にサインイン',
    remoteSignInWithProvider: provider => `${provider} でサインイン`,
    remoteSignInConnected: 'リモートサインインが完了しました。',
    remoteSignInRequired: 'このデスクトップアプリを接続する前に、リモートサインインを完了してください。',
    remoteConnectFirst: 'まず URL を入力し、サインインまたはトークン入力を完了してください。',
    remoteTest: '接続をテスト',
    remoteApplying: '接続中…',
    remoteConnect: 'この Hermes インスタンスを使う',
    remoteConnected: (baseUrl, version) => `${baseUrl}${version ? ` (${version})` : ''} に接続しました。`,
    remoteSaved: 'リモート Hermes 接続を保存しました。',
    remoteApplyFailed: 'そのリモート Hermes インスタンスに切り替えられませんでした。',
    remoteProbeLabel: '接続タイプ',
