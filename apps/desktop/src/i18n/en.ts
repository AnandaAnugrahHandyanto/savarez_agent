...
export const en: Translations = {
  ...
  rightSidebar: {
    ...
    loadingChanges: 'Loading session changes',
    changesLoadFailed: 'Could not load session changes',
    changesNoProjectTitle: 'No project',
    changesNoProjectBody: 'Set a working directory to inspect Git changes.',
    changesNotGitTitle: 'No Git repository',
    changesNotGitBody: 'This workspace is not inside a Git repository.',
    changesCleanTitle: 'Clean workspace',
    changesCleanBody: 'No local changes since HEAD.',
    changedFiles: 'Files',
    addedLines: 'Added',
    removedLines: 'Removed',
    binaryDiff: 'Binary file — line diff is not available.',
    untrackedDiff: 'Untracked file — add it to Git before a line diff is available.',
    noDiffPreview: 'No line-level diff preview for this file.',
    sessionChanges: 'Session changes',
    changesNoSessionTitle: 'No active session',
    changesNoSessionBody: 'Open or continue a chat session to see turn-by-turn file changes.',
    changedTurns: 'Turns',
    filesChangedInline: 'files',
