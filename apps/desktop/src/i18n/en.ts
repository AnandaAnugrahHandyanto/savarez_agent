...
export const en: Translations = {
  ...
  agents: {
    ...
    streaming: 'Streaming',
    files: 'Files',
    tabs: { overview: 'Overview', timeline: 'Timeline', files: 'Files' },
    liveHint: 'Latest event stream is shown first; switch tabs for files or the full timeline.',
    taskIndex: (index, count) => `Task ${index} of ${count}`,
    noEvents: 'No stream events yet.',
    noFiles: 'No files read or written yet.',
    reads: 'Reads',
    writes: 'Writes',
