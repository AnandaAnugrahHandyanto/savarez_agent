...
export const en: Translations = {
  ...
  boot: {
    ready: 'Savarez Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Savarez settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingSavarezDesktop: 'Starting Savarez Desktop…'
    },
    errors: {
      backgroundExited: 'Savarez background process exited.',
      backgroundExitedDuringStartup: 'Savarez background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Savarez backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Savarez Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Savarez defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Savarez follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Savarez checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Savarez configuration...',
    ...
    gateway: {
      ...
      intro:
        'Savarez Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Savarez backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Savarez backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Savarez backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Savarez Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Savarez ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Savarez runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Savarez desktop' },
    ...
    hermesActiveSessions: (version, count) => `Savarez ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Savarez environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Savarez will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Savarez...',
    placeholderReconnecting: 'Reconnecting to Savarez…',
    ...
    attachUrlDesc: 'Savarez will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Savarez can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Savarez is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Savarez backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Savarez from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Savarez will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Savarez updater will take over in its own window and reopen Savarez when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Savarez reconnects automatically when it’s back.',
    applyingClose: 'Savarez will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Savarez needs a one-time install',
    ...
    settingUpTitle: 'Setting up Savarez Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Savarez CLI or desktop instance is running. Stop any running Savarez instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Savarez installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Savarez Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Savarez is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Savarez…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Savarez',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Savarez at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Savarez connects automatically',
      loopback: 'Opens your browser to sign in — Savarez connects automatically',
    ...
    authorizeThere: 'Authorize Savarez there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Savarez there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Savarez inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Savarez will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Savarez is restarting...',
      askRestart: 'Ask Savarez to restart the server',
      lookingRestart: taskId => `Savarez is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Savarez is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Savarez finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Savarez could not restart the server.',
      stillWorking:
        'Savarez is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Savarez is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Savarez gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Savarez won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Savarez needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Savarez needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Savarez Desktop to use Save Image.',
    restartToSaveImages: 'Restart Savarez Desktop to save images',
