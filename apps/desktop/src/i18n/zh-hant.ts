...
export const zhHant = defineLocale({
  ...
  rightSidebar: {
    ...
    loadingChanges: '正在載入工作區變更',
    changesLoadFailed: '無法載入工作區變更',
    changesNoProjectTitle: '沒有專案',
    changesNoProjectBody: '設定工作目錄以檢視 Git 變更。',
    changesNotGitTitle: '不是 Git 儲存庫',
    changesNotGitBody: '此工作區不在 Git 儲存庫中。',
    changesCleanTitle: '工作區乾淨',
    changesCleanBody: '自 HEAD 以來沒有本機變更。',
    changedFiles: '檔案',
    addedLines: '新增',
    removedLines: '移除',
    binaryDiff: '二進位檔案 — 無法顯示逐行 diff。',
    untrackedDiff: '未追蹤檔案 — 加入 Git 後才會有逐行 diff。',
    noDiffPreview: '此檔案沒有逐行 diff 預覽。',
    sessionChanges: '工作階段變更',
    changesNoSessionTitle: '沒有作用中的工作階段',
    changesNoSessionBody: '開啟或繼續聊天工作階段，即可依回合檢視檔案變更。',
    changedTurns: '回合',
    filesChangedInline: '個檔案',
    turnLabel: index => `回合 ${index}`
  },
