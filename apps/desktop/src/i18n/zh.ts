...
export const zh: Translations = {
  ...
  rightSidebar: {
    ...
    changes: '更改',
    refreshChanges: '刷新更改',
    loadingChanges: '正在加载工作区更改',
    changesLoadFailed: '无法加载工作区更改',
    changesNoProjectTitle: '没有项目',
    changesNoProjectBody: '设置工作目录以查看 Git 更改。',
    changesNotGitTitle: '不是 Git 仓库',
    changesNotGitBody: '此工作区不在 Git 仓库中。',
    changesCleanTitle: '工作区干净',
    changesCleanBody: '自 HEAD 以来没有本地更改。',
    changedFiles: '文件',
    addedLines: '新增',
    removedLines: '删除',
    binaryDiff: '二进制文件 — 无法显示行级 diff。',
    untrackedDiff: '未跟踪文件 — 添加到 Git 后才有行级 diff。',
    noDiffPreview: '此文件没有行级 diff 预览。',
    sessionChanges: '会话更改',
    changesNoSessionTitle: '没有活动会话',
    changesNoSessionBody: '打开或继续一个聊天会话，即可按回合查看文件更改。',
    changedTurns: '回合',
    filesChangedInline: '个文件',
