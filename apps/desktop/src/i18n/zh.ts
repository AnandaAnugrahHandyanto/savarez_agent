...
export const zh: Translations = {
  ...
  cron: {
    ...
    newCron: '新建定时任务',
    emptyDescNew: '按 cron 表达式定时一个提示词。Hermes 会运行它，并把结果发送到你选择的目的地。',
    ...
    editTitle: '编辑定时任务',
    createTitle: '新建定时任务',
    editDesc: '更新定时、提示词或投递目标。更改将在下次运行时生效。',
    createDesc: '定时一个提示词以自动运行。使用 cron 语法或类似"每 15 分钟"的自然语言。',
    nameLabel: '名称',
