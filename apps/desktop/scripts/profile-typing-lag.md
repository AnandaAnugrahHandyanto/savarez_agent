...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/savarez-typing
# → /tmp/savarez-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/savarez-typing.before.heapsnapshot
# → /tmp/savarez-typing.after.heapsnapshot
```
