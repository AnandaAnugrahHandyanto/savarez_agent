 ...
 * product name (`Savarez`). If a PREVIOUS `npm run pack` was interrupted
 ...
 *   '.../release/linux-unpacked/electron' -> '.../release/linux-unpacked/Savarez'
 *
 ...
 * (the mac-unpacked Savarez.app bundle) and Windows (win-unpacked), so we
