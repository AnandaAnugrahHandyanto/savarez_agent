...
- 연애 감정에 외모 열등감과 입결 공포가 섞여 있는 현재 오르비 신호와 맞는다.
- 약대 vs 계약학과라는 비교 축은 단순 캠퍼스 연애보다 훨씬 강한 자존심 게임을 만든다.
- 가짜 연애, 들킴, 질투, 캡처 유출이라는 장치가 에피소드 말미 클릭 훅으로 잘 작동한다.

## Character Promise
- 윤태준: 약대 가능선을 계산하면서도 자기 얼굴, 집안, 학교 간판을 동시에 의식하는 남주
- 서재이: 이성적이고 잘난 척하지만 "나는 사랑받는 선택이 아니라 효율적인 선택"이라는 모멸을 품은 여주

## Engine Promise
이 작품의 로맨스는 다정함으로 앞으로 가는 게 아니라, 서로가 감추고 싶은 열등감을 제일 먼저 알아채기 때문에 앞으로 간다. 그래서 한 컷의 표정, 한 장의 성적표, 한 줄의 익명 게시판 캡처가 곧 관계 진전이다.
