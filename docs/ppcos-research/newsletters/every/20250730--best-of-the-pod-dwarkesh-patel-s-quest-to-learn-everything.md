...
Meridian/Midjourney/Every illustration.

Our podcast is on hiatus for the month of August, so we're re-upping some of the best interviews we've done on AI & I. Today we're featuring Dan Shipper's in-depth chat with Dwarkesh Patel, host of the Dwarkesh Podcast—a show that's gained huge success thanks to its deeply researched interviews with experts across AI, history, and geopolitics. We dive into how Dwarkesh uses AI to read, learn, and accelerate his intellectual growth. As always, you can watch on X or YouTube, or listen on Spotify or Apple Podcasts. —Kate Lee
...
Listen or watch on Spotify (make sure to follow to help us rank!)
