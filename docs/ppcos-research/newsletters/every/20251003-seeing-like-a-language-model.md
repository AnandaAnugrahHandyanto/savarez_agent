...
If we think logically and clearly enough about anything in the world, we can figure it out (like how you can solve any puzzle if you stare at it long enough).

Once we figure something out, we should be able to write it down in a way that is so clear and explicit that anyone else can understand and test it for themselves (like a good recipe that anyone can follow).

If something is really true, it should be true no matter where you are or who you are (gravity works the same whether you're in Tokyo or Toronto).

Real truth works like math and can't contradict itself (A is A and B is B, and something can’t be both A and B at the same time).

Finally, the truth is always simple, and if it’s not simple, it means it’s not yet the truth.
