...
let
  ...
  pythonPackageOverrides = final: _prev:
    if isAarch64Darwin then {
      ...
      # ffmpeg-headless sibling outputs (aarch64-darwin), causing SIGKILL during
      # pythonImportsCheck and pytestCheckPhase. Drop once https://github.com/NixOS/nix/pull/15638 lands.
