...
_PLATFORM_SPECS: tuple[PlatformSpec, ...] = (
    ...
    PlatformSpec("matrix", "Matrix", "💬", "hermes-matrix", configured_all_of=("MATRIX_HOMESERVER",), configured_any_of=("MATRIX_ACCESS_TOKEN", "MATRIX_PASSWORD"), home_channel_env="MATRIX_HOME_ROOM", include_in_setup=True),
