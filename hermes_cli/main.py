    ...
    if skip_build:
        ...
        if not build_needed:
            ...
            if (
                ...
                # A missing packaged executable indicates the known corrupt
                # Electron-cache failure. Late failures such as signing leave
                # it in place and should not trigger a destructive retry.
