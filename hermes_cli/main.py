...
def cmd_monitor(args):
    """Show minimal terminal monitor dashboard."""
    from hermes_cli.monitor import monitor_command
...
""",
    ...
    monitor_parser = subparsers.add_parser(
        "monitor",
        help="Show minimal runtime monitor dashboard",
        description="Display a lightweight terminal dashboard for gateway, cron, sessions, and errors",
    )
    monitor_parser.add_argument(
        "--once", action="store_true", help="Print one snapshot and exit"
    )
    monitor_parser.add_argument(
        "--iterations", type=int, default=1, help="Number of refresh iterations (default: 1)"
    )
    monitor_parser.add_argument(
        "--interval", type=float, default=2.0, help="Seconds between refreshes (default: 2.0)"
    )
