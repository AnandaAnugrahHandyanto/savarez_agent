...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("9010", "Enter 90/10 autonomous mode for this session", "Configuration"),
    CommandDef("transparency", "Enter transparency mode: plan/diagnose before executing", "Configuration"),
    CommandDef("normal", "Exit special modes and return to normal behavior", "Configuration"),
