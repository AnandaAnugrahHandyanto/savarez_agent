...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("skills", "Search, install, inspect, or manage skills",
               ...
               subcommands=("search", "browse", "inspect", "install", "audit", "export")),
    CommandDef("sync", "Back up / sync your profile (skills, memory, persona) to your own git repo",
               "Tools & Skills", cli_only=True,
               args_hint="[status|push|pull|init|share]",
               subcommands=("status", "push", "pull", "init", "share")),
