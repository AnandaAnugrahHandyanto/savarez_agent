...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("background", "Run a prompt in the background", "Session",
               aliases=("bg", "btw"), args_hint="<prompt|list|status|artifacts|promote>"),
    CommandDef("sidequest", "Create or follow up durable async work", "Session",
               aliases=("sq",), args_hint="[goal|id status|id follow-up]"),
