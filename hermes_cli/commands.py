...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("learning", "Personal learning: topics, lessons, spaced-repetition quizzes",
               "Tools & Skills", args_hint="[subcommand]",
               subcommands=("topics", "list", "show", "new", "progress", "lesson",
                            "cards", "due", "weak", "schedule", "pause", "resume",
                            "archive")),
