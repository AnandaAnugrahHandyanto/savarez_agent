...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("title", "Set a title for the current session", "Session",
               args_hint="[name]"),
    CommandDef("handoff", "Create/show a session handoff pack; CLI also supports platform handoff", "Session",
               args_hint="[status|<platform>]"),
    CommandDef("autopilot", "Autopilot control-plane operations", "Session",
               gateway_only=True, args_hint="rollover"),
