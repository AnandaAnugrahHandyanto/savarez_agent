...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("yolo", "Toggle YOLO mode (skip all dangerous command approvals)",
               "Configuration"),
    CommandDef("readonly", "Toggle read-only mode (block destructive operations)",
               "Configuration", aliases=("read-only",), args_hint="[on|off|status]",
               subcommands=("on", "off", "status")),
    ...
    CommandDef("pr", "Create or manage GitHub pull requests",
               "Tools & Skills", cli_only=True,
               args_hint="[create|list|view] [args...]",
               subcommands=("create", "list", "view")),
    CommandDef("feature", "Submit or manage feature requests",
               "Tools & Skills", cli_only=True,
               args_hint="[submit|list|get|update|delete] [args...]",
               subcommands=("submit", "list", "get", "update", "delete")),
