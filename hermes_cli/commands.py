...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("insights", "Show usage insights and analytics", "Info",
               args_hint="[days]"),
    CommandDef("eval", "Run or inspect local Hermes behavioral evals", "Info",
               cli_only=True, args_hint="[list|run|recent|show]",
               subcommands=("list", "run", "recent", "show")),
    CommandDef("failures", "Inspect normalized failure-analysis records", "Info",
               cli_only=True, args_hint="[recent|top|show]",
               subcommands=("recent", "top", "show")),
