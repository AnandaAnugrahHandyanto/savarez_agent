...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("yt-wisdom", "Mine a YouTube video for key facts and wisdom, store in Obsidian", "Tools & Skills",
               gateway_only=True, args_hint="<YouTube URL> [--max N]"),
    CommandDef("present", "Generate a slide deck on any topic using pptxgenjs", "Tools & Skills",
               args_hint="<topic> [--slides N]"),
