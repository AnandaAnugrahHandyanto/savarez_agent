...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("compress", "Compress conversation context (add 'here [N]' to keep recent N turns)", "Session",
               aliases=("compression",), args_hint="[here [N] | focus topic]"),
    ...
    CommandDef("voice", "Toggle voice mode", "Configuration",
               args_hint="[on|off|tts|status|channel|join|leave|stop|realtime join|realtime leave|realtime status]",
               subcommands=("on", "off", "tts", "status", "channel", "join", "leave", "stop", "realtime")),
