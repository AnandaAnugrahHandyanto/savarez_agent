...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("exec", "Execute a shell command directly on the gateway host", "Session",
               gateway_only=True, args_hint="[--background] [--notify] [--pty] [--timeout N] [--workdir PATH] -- <command>"),
    CommandDef("gh", "Execute a GitHub CLI command directly on the gateway host", "Session",
               gateway_only=True, args_hint="[--background] [--notify] [--timeout N] [--workdir PATH] -- <gh args>"),
