...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("bind-task", "Bind this chat/thread to a Todoist task for context recovery", "Session",
               gateway_only=True, aliases=("bind_task",), args_hint="<todoist_task_id> [title]"),
    ...
    CommandDef("recover", "Show the durable context/task anchor for this chat/thread", "Session",
               gateway_only=True),
