...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goal", "Set a standing goal Hermes works on across turns until achieved", "Session",
               args_hint="[text | pause | resume | clear | status | review [mads] | accept]"),
    CommandDef("subgoal", "Add or manage extra criteria on the active goal", "Session",
               args_hint="[text | remove N | clear]"),
    CommandDef("mission", "Run a bounded checkpointed mission via cron", "Session",
               args_hint="[start|list|status|pause|resume|stop|run]",
               subcommands=("start", "list", "status", "pause", "resume", "stop", "run")),
