...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("worktree", "Manage this Discord thread's isolated git worktree", "Session",
               gateway_only=True, args_hint="[status|commit <msg>|pr|clean --force]",
               subcommands=("status", "commit", "pr", "clean")),
