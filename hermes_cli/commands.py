...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef(
        "wsummary",
        "Summarize stored WhatsApp conversation history",
        "Session",
        gateway_only=True,
        args_hint="<field=value ...>",
    ),
    CommandDef(
        "wthread",
        "Retrieve or send within one exact WhatsApp thread",
        "Session",
        gateway_only=True,
        args_hint="<retrieve|send> <field=value ...>",
        subcommands=("retrieve", "send"),
    ),
