...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("workspace", "Create a dedicated Discord work channel and kick off the job there", "Session",
               gateway_only=True, args_hint="<prompt>"),
    CommandDef("complete", "Mark this Discord work channel complete and offer to delete it", "Session",
               gateway_only=True),
