...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("delegation", "Inspect multi-agent delegation runs (status, verify, report)",
               "Tools & Skills", cli_only=True, args_hint="[status|verify|report]",
               subcommands=("status", "verify", "report")),
