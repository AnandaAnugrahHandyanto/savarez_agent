...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("memory", "Review pending memory writes / toggle the gate, or show contents",
               "Tools & Skills",
               args_hint="[pending|approve|reject|approval|show] [id|on|off|memory|user]",
               subcommands=("pending", "approve", "reject", "approval", "show")),
