...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("notebooklm", "Create a NotebookLM learning pack (study guide, slides, quiz, cards, mind map)",
               "Tools & Skills", aliases=("nlm", "learnpack"),
               args_hint="[topic|url|repo|kb topic|inbox name]",
               subcommands=("kb", "url", "repo", "inbox", "quiz", "cards")),
