...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agents", "Show active subagents and running tasks", "Session",
               aliases=("tasks",)),
    ...
    CommandDef("ultracode", "Toggle ultracode session mode — auto-run real multi-agent workflows for substantive tasks", "Configuration",
               cli_only=True, args_hint="[on|off|status]",
               subcommands=("on", "off", "status")),
    CommandDef("workflow", "Run a task through PLAN → subagents → SYNTHESIZE orchestration", "Configuration",
               cli_only=True, args_hint="<task>"),
