...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("history", "Show conversation history", "Session",
               cli_only=True),
    CommandDef("tasks", "Show all sessions (task history panel)", "Session",
               cli_only=True, args_hint="[--title <text>] [--limit <n>]"),
    CommandDef("save", "Save the current conversation", "Session",
               cli_only=True),
    CommandDef("retry", "Retry the last message (resend to agent)", "Session"),
    CommandDef("undo", "Undo the last file modification (restore from snapshot)", "Session"),
    CommandDef("diff", "Show diff between current file and last undo snapshot", "Session"),
    CommandDef("redo", "Redo the last undone file operation", "Session"),
    ...
    CommandDef("resume", "Resume a previously-named session", "Session",
               args_hint="[name]"),
    CommandDef("delete", "Delete a session by ID or title", "Session",
               cli_only=True, args_hint="<session_id_or_title>"),
    CommandDef("purge", "Delete all ended sessions", "Session",
               cli_only=True),
    ...
    CommandDef("yolo", "Toggle YOLO mode (skip all dangerous command approvals)",
               "Configuration"),
    CommandDef("permissions", "Show or set permission mode (bounded|unrestricted)",
               "Configuration", args_hint="[mode]"),
