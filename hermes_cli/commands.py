...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reaction", "Configure Telegram reaction shortcuts", "Configuration",
               gateway_only=True, aliases=("reactions",), args_hint="[setup|status|delete|help]",
               subcommands=("setup", "status", "delete", "disable", "uninstall", "help")),
