...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("codex", "管理 Codex 多账号：/codex <subcommand>", "Tools & Skills",
               aliases=("codex-accounts",),
               args_hint="<list|probe|doctor|switch|remove|run|watch|add> [...]",
               subcommands=("add", "list", "switch", "remove", "probe", "watch", "run", "doctor", "help"),
               cli_only=True),
    CommandDef("codextool", "Run Codex account-manager commands: /codexTool <subcommand>", "Tools & Skills",
               args_hint="<list|probe|doctor|switch|remove|run|watch|add> [...]",
               subcommands=("add", "list", "switch", "remove", "probe", "watch", "run", "doctor", "help")),
