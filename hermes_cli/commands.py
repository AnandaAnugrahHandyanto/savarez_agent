...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("monitor", "Show minimal runtime monitor dashboard", "Info", cli_only=True,
               args_hint="[--once|--iterations N|--interval S]"),
    ...
    CommandDef("team", "Manage Hermes-native multi-agent team workflows",
               "Tools & Skills", args_hint="[run|status|events|roles|approvals|approve|reject|metrics|watch|sandbox|replans|approval-audit|templates]",
               subcommands=("run", "status", "events", "roles", "approvals", "approve", "reject", "metrics", "watch", "sandbox", "replans", "approval-audit", "templates")),
