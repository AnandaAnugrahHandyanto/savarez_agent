...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("verbose", "Cycle general verbose display: off -> new -> all -> verbose",
               "Configuration", cli_only=True,
               gateway_config_gate="display.tool_progress_command"),
    CommandDef("tooltrace", "Toggle compact tool-use display", "Configuration",
               cli_only=True, aliases=("tool-trace",), args_hint="[on|off|status]",
