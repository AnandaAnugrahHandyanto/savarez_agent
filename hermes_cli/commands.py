...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("effort", "Manage reasoning effort and display (alias for /reasoning)", "Configuration",
               aliases=("reasoning",), args_hint="[level|show|hide]",
               subcommands=("none", "minimal", "low", "medium", "high", "max", "show", "hide", "on", "off")),
