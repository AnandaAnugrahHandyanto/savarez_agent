...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("config", "Show current configuration", "Configuration",
               cli_only=True),
    CommandDef("model", "Switch or route models for this session", "Configuration",
               aliases=("provider",), args_hint="[model] | [main|escalate [provider/model]] [--provider name] [--global]"),
    CommandDef("think", "Route to the cheap/main or senior/escalate profile", "Configuration",
               args_hint="[cheap|senior]"),
    CommandDef("review-with-openai", "Switch to the senior OpenAI/Codex review profile", "Configuration",
               aliases=("review_with_openai", "review-openai")),
    ...
    CommandDef("quota", "Show account quota remaining without starting an agent", "Info",
               gateway_only=True),
