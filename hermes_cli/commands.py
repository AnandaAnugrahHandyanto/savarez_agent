...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("context", "Show or control the current project/batch context", "Session",
               aliases=("ctx",), args_hint="[status|new|switch|pause|done|handoff] [args]",
               subcommands=("status", "new", "switch", "pause", "done", "handoff"), gateway_only=True),
