...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("spawn-topic", "Create a Telegram topic and run a visible child agent", "Session",
               gateway_only=True, aliases=("spawn",), args_hint="<topic name> :: <prompt>"),
    CommandDef("prompt-topic", "Send a follow-up prompt to a visible topic delegate", "Session",
               gateway_only=True, aliases=("vprompt",), args_hint="<telegram:chat:thread> :: <prompt>"),
    CommandDef("visible-sessions", "List visible topic delegate sessions", "Session",
               gateway_only=True, aliases=("vsessions",)),
