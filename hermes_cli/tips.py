...
TIPS = [
    ...
    "Set approvals.mode: smart to let an LLM auto-approve safe commands and auto-deny dangerous ones; add approvals.smart_deny: ask to prompt instead of hard-blocking smart denials.",
