...
TIPS = [
    ...
    "mixture_of_agents routes hard problems through Xiaomi MiMo V2.5 Pro plus OpenRouter Gemma 4 31B and Mistral Small 4 collaborators.",
    "spar uses MiMo V2.5 Pro as builder, OpenRouter Gemma 4 31B as reviewer, and OpenRouter Mistral Small 4 as judge.",
