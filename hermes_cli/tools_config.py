...
CONFIGURABLE_TOOLSETS = [
    ...
    ("session_search",  "🔎 Session Search",            "search past conversations by query (or browse recent sessions)"),
    ("session_recap",   "📝 Session Recap",             "search past conversations by time window"),
