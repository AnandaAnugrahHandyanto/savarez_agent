...
CONFIGURABLE_TOOLSETS = [
    ...
    ("google_workspace", "🗂️ Google Workspace",        "profile-scoped read-only Drive/Gmail search and read"),
...
#
# Google Workspace is also off by default: it is profile-scoped and should
# only appear after explicit setup/policy configuration.
_DEFAULT_OFF_TOOLSETS = {"moa", "homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "google_workspace"}
