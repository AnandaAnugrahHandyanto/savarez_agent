...
def _resolve_runtime_from_pool_entry(
    *,
    ...
    if provider == "openai-codex":
        ...
        # An explicit config.yaml base_url always wins over the auto-detected
        # pool entry URL (e.g. user switched from OpenAI-compat to Anthropic
        # protocol endpoint for Z.AI).  Env var overrides still win (#6039).
        cfg_base_url = ""
