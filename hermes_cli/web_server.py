...
async def upload_chat_image(payload: ChatImageUpload, profile: Optional[str] = None):
    ...
    page uploads them here, then pastes the returned gateway-visible path into
    the TUI. The existing TUI paste path turns that path into an image
    attachment without mutating any draft text.
    """
