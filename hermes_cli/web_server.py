...
async def apply_telegram_onboarding(pairing_id: str, body: TelegramOnboardingApply):
    allowed_user_ids = []
    seen = set()
...
def _dashboard_plugin_config_identity(
    plugin_dir: Path, dashboard_name: str
) -> tuple[str, str]:
