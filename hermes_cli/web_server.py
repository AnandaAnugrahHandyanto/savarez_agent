...
_SCHEMA_OVERRIDES: Dict[str, Dict[str, Any]] = {
    ...
    "dashboard.theme": {
        ...
        "options": ["default", "midnight", "ember", "mono", "ferrosa", "cyberpunk", "rose"],
    },
...
_BUILTIN_DASHBOARD_THEMES = [
    ...
    {"name": "ferrosa",   "label": "Ferrosa",        "description": "Restrained Ferrosa brand system — dark graphite, rust accents, thin rules"},
