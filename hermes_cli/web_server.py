...
_SCHEMA_OVERRIDES: Dict[str, Dict[str, Any]] = {
    ...
    "dashboard.theme": {
        ...
        "options": ["default", "default-large", "nous-blue", "catppuccin-mocha", "midnight", "ember", "mono", "cyberpunk", "rose"],
    },
...
_BUILTIN_DASHBOARD_THEMES = [
    ...
    {"name": "catppuccin-mocha", "label": "Catppuccin Mocha",     "description": "Soft pastel dark dashboard inspired by Catppuccin Mocha"},
