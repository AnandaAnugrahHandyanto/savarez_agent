...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Nebula Frost",        "description": "Cool glass over a midnight nebula — calm, bright, and original"},
    {"name": "default-large", "label": "Nebula Frost (Large)", "description": "Nebula Frost with bigger fonts and roomier spacing"},
