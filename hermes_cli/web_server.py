...
def _apply_main_model_assignment(
    ...
    if provider_norm == "custom":
        ...
        if resolved_base_url:
            ...
            # Preserve existing custom endpoint when Desktop omitted base_url.
            pass
    elif provider_norm == "local" and supplied_base_url:
        model_cfg["base_url"] = supplied_base_url
    elif model_cfg.get("base_url"):
        model_cfg["base_url"] = ""
...
async def get_profiles_sessions(
    ...
    for name, home in targets:
        ...
        try:
            ...
            if model_filter:
                rows = [s for s in rows if not s.get("model") or s.get("model") == model_filter]
