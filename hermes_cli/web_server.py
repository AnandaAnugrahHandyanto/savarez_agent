...
def _spawn_hermes_action(subcommand: List[str], name: str) -> subprocess.Popen:
    ...
    popen_env = {**os.environ, "HERMES_NONINTERACTIVE": "1"}
    popen_env["HERMES_DASHBOARD_ACTION_NAME"] = name
    popen_env["HERMES_DASHBOARD_ACTION_RESULT_FILE"] = str(_action_result_path(name))
