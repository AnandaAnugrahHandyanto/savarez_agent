...
def dispatch_once(
    ...
    *,
    ...
    # Honour kanban.max_in_progress: if the board already has enough
    # running tasks, skip spawning this tick so slow workers (local LLMs,
    # resource-constrained hosts) can finish what they have before more
    # tasks pile up and time out.
    spawned = 0
