...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "MSTEAMS_WEBHOOK_HOST", "MSTEAMS_WEBHOOK_PORT", "MSTEAMS_WEBHOOK_PATH",
    "MSTEAMS_HOME_CHANNEL", "MSTEAMS_HOME_CHANNEL_NAME",
    "MSTEAMS_REQUIRE_MENTION", "MSTEAMS_REPLY_STYLE", "MSTEAMS_DM_POLICY",
    "MSTEAMS_GROUP_POLICY", "MSTEAMS_ALLOW_FROM", "MSTEAMS_GROUP_ALLOW_FROM",
    "MSTEAMS_CHUNK_MODE", "MSTEAMS_DANGEROUSLY_ALLOW_NAME_MATCHING", "MSTEAMS_TEAMS_JSON",
...
OPTIONAL_ENV_VARS = {
    ...
    "MSTEAMS_APP_ID": {
        "description": "Microsoft Teams Azure Bot App ID",
    ...
    "MSTEAMS_APP_PASSWORD": {
        "description": "Microsoft Teams Azure Bot client secret / app password",
    ...
    "MSTEAMS_TENANT_ID": {
        "description": "Microsoft Entra tenant ID for the Azure Bot",
        "prompt": "Microsoft Teams Tenant ID",
        "url": "https://portal.azure.com/",
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_ALLOWED_USERS": {
        "description": "Comma-separated Microsoft Teams user IDs allowed to use the bot",
        "prompt": "Allowed Microsoft Teams user IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_REQUIRE_MENTION": {
        "description": "Require @mention in Microsoft Teams group/channel chats (default: true)",
        "prompt": "Microsoft Teams require mention (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_REPLY_STYLE": {
        "description": "Microsoft Teams reply style: thread or top-level",
        "prompt": "Microsoft Teams reply style (thread/top-level)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_DM_POLICY": {
        "description": "Microsoft Teams DM policy: pairing, allowlist, open, or disabled",
        "prompt": "Microsoft Teams DM policy",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_GROUP_POLICY": {
        "description": "Microsoft Teams group/channel policy: allowlist, open, or disabled",
        "prompt": "Microsoft Teams group policy",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_CHUNK_MODE": {
        "description": "Microsoft Teams outbound chunking mode: length or newline",
        "prompt": "Microsoft Teams chunk mode (length/newline)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_ALLOW_FROM": {
        "description": "Comma-separated Microsoft Teams DM sender IDs allowed when dm_policy=allowlist",
        "prompt": "Microsoft Teams DM allowlist (comma-separated IDs)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_GROUP_ALLOW_FROM": {
        "description": "Comma-separated Microsoft Teams group/channel sender IDs allowed when group_policy=allowlist",
        "prompt": "Microsoft Teams group allowlist (comma-separated IDs)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_DANGEROUSLY_ALLOW_NAME_MATCHING": {
        "description": "Allow mutable display-name matching in Teams allowlists (unsafe; default false)",
        "prompt": "Microsoft Teams dangerously allow name matching (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_TEAMS_JSON": {
        "description": "JSON object for Microsoft Teams team/channel overrides (advanced)",
        "prompt": "Microsoft Teams teams JSON override",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_HOME_CHANNEL": {
        "description": "Default Microsoft Teams chat/channel for cron delivery when no explicit destination is provided",
        "prompt": "Microsoft Teams home channel ID",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "MSTEAMS_HOME_CHANNEL_NAME": {
        "description": "Human-friendly label for the Microsoft Teams home channel",
        "prompt": "Microsoft Teams home channel name",
        "url": None,
        "password": False,
        "category": "messaging",
    },
