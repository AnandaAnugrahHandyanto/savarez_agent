...
OPTIONAL_ENV_VARS = {
    ...
    "GOOGLE_CHAT_GCP_PROJECT": {
        "description": "GCP project ID for Google Chat via Pub/Sub",
        "prompt": "Google Chat GCP Project ID",
        "url": "https://console.cloud.google.com/",
        "password": False,
        "category": "messaging",
    },
    "GOOGLE_CHAT_PUBSUB_SUBSCRIPTION": {
        "description": "Pub/Sub subscription name for inbound Chat events (default: hermes-chat-inbound-sub)",
        "prompt": "Google Chat Pub/Sub subscription",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "GOOGLE_CHAT_CREDENTIALS": {
        "description": "Path to service account JSON key for Chat API (leave empty for ADC)",
        "prompt": "Google Chat credentials path",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "GOOGLE_CHAT_ALLOWED_USERS": {
        "description": "Comma-separated Google Workspace email addresses allowed to use the bot",
        "prompt": "Allowed Google Chat users (comma-separated emails)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "GOOGLE_CHAT_HOME_CHANNEL": {
        "description": "Google Chat space name for cron/notification delivery (e.g. spaces/AAAA...)",
        "prompt": "Google Chat home space",
        "url": None,
        "password": False,
        "category": "messaging",
    },
