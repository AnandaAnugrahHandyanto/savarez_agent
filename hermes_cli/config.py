...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "KASIA_ENABLED", "KASIA_SEED_PHRASE", "KASIA_INDEXER_URL",
    "KASIA_NODE_WBORSH_URL", "KASIA_NETWORK", "KASIA_ALLOWED_USERS",
    "KASIA_ALLOW_ALL_USERS", "KASIA_HOME_CHANNEL",
...
OPTIONAL_ENV_VARS = {
    ...
    "KASIA_ENABLED": {
        "description": "Enable the Kasia gateway bridge (true/false)",
        "prompt": "Enable Kasia gateway (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_SEED_PHRASE": {
        ...
        "url": "https://github.com/K-Kluster/Kasia",
        "password": True,
        "category": "messaging",
    },
    "KASIA_INDEXER_URL": {
        "description": "Trusted Kasia indexer base URL used for inbound sync",
        "prompt": "Kasia indexer URL",
        "url": "https://github.com/K-Kluster/Kasia",
        "password": False,
        "category": "messaging",
    },
    "KASIA_NODE_WBORSH_URL": {
        "description": "Kaspa wborsh / wRPC node URL used to submit Kasia transactions",
        "prompt": "Kaspa node URL",
        "url": "https://github.com/kaspanet/rusty-kaspa",
        "password": False,
        "category": "messaging",
    },
    "KASIA_NETWORK": {
        "description": "Kaspa network name (for example mainnet or testnet-10)",
        "prompt": "Kaspa network",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_FEE_POLICY": {
        "description": "Kasia fee policy for outbound transactions (priority, normal, low, or auto). Default: auto.",
    ...
    "KASIA_ALLOW_ALL_USERS": {
        "description": "Allow any Kasia address to complete the handshake and message Hermes (true/false)",
        "prompt": "Allow all Kasia users (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_HOME_CHANNEL": {
        "description": "Default Kasia address used as the platform home channel for tool delivery",
        "prompt": "Kasia home channel address",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_INDEXER_URLS": {
        "description": "Comma-separated Kasia indexer base URLs used as the inbound sync fallback pool",
        "prompt": "Kasia indexer URL pool (comma-separated)",
        "url": "https://github.com/K-Kluster/Kasia",
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_NODE_WBORSH_URLS": {
        "description": "Comma-separated Kaspa node URLs used as the fallback submission pool",
        "prompt": "Kaspa node URL pool (comma-separated)",
        "url": "https://github.com/kaspanet/rusty-kaspa",
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_KNS_URL": {
        "description": "Optional KNS API override. Leave unset to use the network default.",
        "prompt": "KNS API URL override",
        "url": "https://github.com/kasplex/kns-domains",
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "KASIA_BRIDGE_PORT": {
        "description": "Local TCP port for the Kasia bridge health and control API (default: 3010).",
        "prompt": "Kasia bridge port",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_SEND_WAIT_MS": {
        "description": "How long Hermes waits for a Kasia send job before timing out (milliseconds).",
        "prompt": "Kasia send wait timeout (ms)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_MAX_MULTIPARTS": {
        "description": "Maximum number of Kasia multipart segments Hermes will emit for one message.",
        "prompt": "Kasia max multiparts",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_ALLOWED_BROADCAST_CHANNELS": {
        "description": "Comma-separated Kasia broadcast channels allowed to deliver into Hermes.",
        "prompt": "Allowed Kasia broadcast channels (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "KASIA_ALLOW_ALL_BROADCAST_CHANNELS": {
        "description": "Allow broadcast messages from any Kasia channel (true/false). Default: false.",
        "prompt": "Allow all Kasia broadcast channels (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
