...
OPTIONAL_ENV_VARS = {
    ...
    "SILICONFLOW_API_KEY": {
        "description": "SiliconFlow API key for OpenAI-compatible multi-model inference",
    ...
    "SILICONFLOW_BASE_URL": {
        "description": "SiliconFlow base URL override (default: https://api.siliconflow.com/v1)",
        "prompt": "SiliconFlow base URL (leave empty for default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "SILICONFLOW_CN_API_KEY": {
        "description": "SiliconFlow China API key for the regional OpenAI-compatible endpoint",
        "prompt": "SiliconFlow China API Key",
        "url": "https://cloud.siliconflow.cn",
        "password": True,
        "category": "provider",
    },
    "SILICONFLOW_CN_BASE_URL": {
        "description": "SiliconFlow China base URL override (default: https://api.siliconflow.cn/v1)",
        "prompt": "SiliconFlow China base URL (leave empty for default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
