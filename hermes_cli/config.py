...
DEFAULT_CONFIG = {
    ...
    "agent": {
        ...
        # Tool/skill registry injection: controls how available tools and skills
        # are surfaced to the model in the system prompt.
        # Values:
        #   "disabled" — no injection (default)
        #   "nudge"    — soft recommendation when user message suggests tool use
        #   "full"     — always inject all available tools/skills into prompt
