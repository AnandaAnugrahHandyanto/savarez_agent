...
OPTIONAL_ENV_VARS = {
    ...
    "CLOUDFLARE_ACCOUNT_ID": {
        "description": "Cloudflare account ID (required for Workers AI)",
    ...
    "CLOUDFLARE_GATEWAY_ID": {
        "description": "Cloudflare AI Gateway ID (optional — routes through AI Gateway for caching/analytics)",
        "prompt": "Cloudflare AI Gateway ID (leave empty to skip)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
