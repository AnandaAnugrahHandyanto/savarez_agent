...
DEFAULT_CONFIG = {
    ...
    # Gemini 5000, Edge 5000, Mistral 4000, Voicebox 5000, NeuTTS/KittenTTS 2000).
    "tts": {
        "provider": "edge",  # "edge" (free) | "elevenlabs" (premium) | "openai" | "xai" | "minimax" | "mistral" | "gemini" | "voicebox" (local server) | "neutts" (local) | "kittentts" (local) | "piper" (local)
        "edge": {
        ...
        "voicebox": {
            ...
            "profile": "",  # Voicebox profile name; profile_id is preferred once known
            "profile_id": "",
            "engine": "kokoro",
            "language": "en",
            "timeout": 180,
