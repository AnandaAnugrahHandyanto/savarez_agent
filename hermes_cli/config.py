...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "NOSTR_ALLOWED_USERS", "NOSTR_ALLOW_ALL_USERS",
...
OPTIONAL_ENV_VARS = {
    ...
    "NOSTR_PRIVATE_KEY": {
        "description": "Nostr private key (hex-encoded or nsec) for encrypted DM messaging",
    ...
    "NOSTR_RELAYS": {
        "description": "Comma-separated Nostr relay WebSocket URLs (default: wss://relay.damus.io,wss://nos.lol,wss://relay.nostr.band)",
    ...
    "NOSTR_ALLOWED_USERS": {
        "description": "Comma-separated Nostr public keys (npub or hex) allowed to message the bot",
        "prompt": "Allowed Nostr pubkeys (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
