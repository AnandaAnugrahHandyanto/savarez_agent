...
OPTIONAL_ENV_VARS = {
    ...
    "HERMES_ANTIGRAVITY_CLIENT_ID": {
        "description": "Google OAuth client ID for antigravity-cli (optional; defaults to credentials discovered from `agy`)",
        "prompt": "Antigravity OAuth client ID (optional)",
        "url": "https://console.cloud.google.com/apis/credentials",
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "HERMES_ANTIGRAVITY_CLIENT_SECRET": {
        "description": "Google OAuth client secret for antigravity-cli (optional)",
    ...
    "HERMES_ANTIGRAVITY_CLI_PATH": {
        "description": "Path to the Antigravity CLI executable used for OAuth client discovery",
        "prompt": "Antigravity CLI path (leave empty to auto-detect `agy`)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "HERMES_ANTIGRAVITY_CLI_HOME": {
        "description": "Directory containing Antigravity CLI OAuth tokens (advanced)",
        "prompt": "Antigravity CLI OAuth directory (leave empty for ~/.gemini/antigravity-cli)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
