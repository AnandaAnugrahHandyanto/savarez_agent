...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "WECHAT_BOT_TOKEN", "WECHAT_ACCOUNT_ID", "WECHAT_ALLOWED_USERS",
    "WECHAT_ALLOW_ALL_USERS", "WECHAT_HOME_CHANNEL", "WECHAT_HOME_CHANNEL_NAME",
    "WECHAT_ILINK_APP_ID", "WECHAT_ILINK_CLIENT_VERSION",
