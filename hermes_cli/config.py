...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "NDR_ENABLED", "NDR_BIN", "NDR_DATA_DIR", "NDR_HOME_CHANNEL",
    "NDR_ALLOWED_USERS", "NDR_ALLOW_ALL_USERS",
...
OPTIONAL_ENV_VARS = {
    ...
    "NDR_ENABLED": {
        "description": "Enable the NDR (nostr-double-ratchet) gateway adapter",
        "prompt": "Enable NDR (true/false)",
    ...
    "NDR_BIN": {
        "description": "Path to the ndr CLI binary (defaults to 'ndr' on PATH)",
        "prompt": "NDR binary path",
        "url": "https://github.com/mmalmi/nostr-double-ratchet",
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "NDR_DATA_DIR": {
        "description": "Optional NDR data directory override; defaults to a profile-safe Hermes path",
        "prompt": "NDR data directory override",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "NDR_ALLOWED_USERS": {
        "description": "Comma-separated NDR sender pubkeys allowed to use the bot",
        "prompt": "Allowed NDR users (comma-separated pubkeys)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "NDR_HOME_CHANNEL": {
        "description": "Default NDR chat target for cron/notification delivery",
        "prompt": "NDR home chat target",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "NDR_ALLOW_ALL_USERS": {
        "description": "Allow all NDR users to interact with the bot",
        "prompt": "Allow all NDR users (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
