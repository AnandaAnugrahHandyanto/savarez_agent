...
OPTIONAL_ENV_VARS = {
    ...
    "NIMBLE_API_KEY": {
        "description": "Nimble API key for web search and extract",
        "prompt": "Nimble API key",
        "url": "https://online.nimbleway.com",
        "tools": ["web_search", "web_extract"],
        "password": True,
        "category": "tool",
    },
...
def set_config_value(key: str, value: str):
    ...
    api_keys = [
        ...
        'TOOL_GATEWAY_USER_TOKEN', 'TAVILY_API_KEY', 'NIMBLE_API_KEY',
