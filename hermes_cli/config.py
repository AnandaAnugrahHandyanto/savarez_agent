...
DEFAULT_CONFIG = {
    ...
    "skills": {
        ...
        # writes via skill_manage (create/edit/patch).  Dangerous verdicts
        # surface as a tool error to the agent, which can retry with the
        # flagged content removed.  External hub installs (trusted/community
        # sources) are always scanned regardless of this setting.
