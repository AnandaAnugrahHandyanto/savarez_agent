...
def _sanitize_env_lines(lines: list) -> list:
    ...
    for line in lines:
        ...
        # Search for known KEY= patterns that appear at the start of the line
        # or after a non-identifier character, so we don't match partial keys
        # that are substrings of other registered keys (e.g. LM_API_KEY is a
        # substring of GLM_API_KEY, but should not trigger a split).
        split_positions = []
