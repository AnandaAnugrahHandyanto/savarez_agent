...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("kimi-coding",    "Kimi Code",                 "Kimi Code / Kimi Coding Plan (api.kimi.com/coding; model: kimi-for-coding)"),
    ProviderEntry("kimi-coding-cn", "Kimi / Moonshot China",      "Moonshot China direct API (api.moonshot.cn/v1; K2/Kimi models)"),
