...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("kimi-coding",    "Moonshot / Kimi",          "Moonshot AI (platform.moonshot.ai) — standard Moonshot keys; Kimi Code keys (sk-kimi-*) auto-route to api.kimi.com/coding"),
    ProviderEntry("kimi-coding-cn", "Moonshot / Kimi (China)",  "Moonshot AI China (api.moonshot.cn) — for users in China"),
