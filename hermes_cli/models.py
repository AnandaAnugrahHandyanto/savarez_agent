...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ...
    ProviderEntry("siliconflow",    "SiliconFlow",              "SiliconFlow (OpenAI-compatible multi-model inference platform)"),
    ProviderEntry("siliconflow-cn", "SiliconFlow (China)",      "SiliconFlow China (regional OpenAI-compatible endpoint with a dedicated model catalog)"),
