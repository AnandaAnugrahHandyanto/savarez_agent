...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "nvidia": [
        # NVIDIA NIM free-tier — curadoria Commander (2026-04-20, 50 picks)
        # Lista autoritativa enviada pelo Commander; preserva exatamente
        # os ids fornecidos. Alguns ids podem nao existir no snapshot API
        # atual (flag na nota de cada secao).
