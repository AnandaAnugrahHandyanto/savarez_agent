...
def run_backup(args) -> None:
    ...
    if not hermes_root.is_dir():
        print(f"Error: Jade home directory not found at {hermes_root}")
        sys.exit(1)
...
def run_import(args) -> None:
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        if (has_config or has_env) and not args.force:
            print()
            print("Warning: Target directory already has a configuration directory.")
        ...
        print("Done. Your configuration has been restored.")
