...
_PLATFORMS = [
    ...
    },
    {
        ...
        "label": "Google Chat",
        "emoji": "💬",
        "token_var": "GOOGLE_CHAT_SUBSCRIPTION_NAME",
        "setup_instructions": [
            "1. Create or select a GCP project; enable Google Chat API and Cloud Pub/Sub API.",
            "2. Create a Service Account (no IAM role at project level needed).",
            ...
            "7. Google Chat API console → Configuration: set app name/avatar, Connection = Cloud Pub/Sub,",
            "   enter the topic name. Enable 1:1 messages and group conversations. Restrict visibility.",
            "8. Install the bot in a space (this fires ADDED_TO_SPACE and resolves its user_id).",
        ],
        "vars": [
            {"name": "GOOGLE_CHAT_PROJECT_ID", "prompt": "GCP project ID (e.g. my-project)", "password": False,
             "help": "The project where your Pub/Sub topic and subscription live."},
            {"name": "GOOGLE_CHAT_SUBSCRIPTION_NAME",
             "prompt": "Pub/Sub subscription (projects/<proj>/subscriptions/<sub>)", "password": False,
             "help": "Full resource name of your pull subscription."},
            {"name": "GOOGLE_CHAT_SERVICE_ACCOUNT_JSON",
             "prompt": "Path to Service Account JSON (or inline JSON)", "password": True,
             "help": "Absolute path to the downloaded SA key. Keep it out of the repo."},
            {"name": "GOOGLE_CHAT_ALLOWED_USERS",
             "prompt": "Allowed user emails (comma-separated)", "password": False,
             "is_allowlist": True,
             "help": "Email addresses of users allowed to DM / trigger the bot."},
            {"name": "GOOGLE_CHAT_HOME_CHANNEL",
             "prompt": "Home space (e.g. spaces/AAAA, or empty)", "password": False,
             "help": "Optional space ID for cron/notification delivery."},
        ],
    },
    {
        "key": "matrix",
