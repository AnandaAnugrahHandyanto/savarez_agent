...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    ...
    "baidu-coding": ProviderConfig(
        id="baidu-coding",
        name="Baidu Coding Plan",
        auth_type="api_key",
        inference_base_url="https://qianfan.baidubce.com/v2/coding",
        api_key_env_vars=("BAIDU_CODING_API_KEY", "BAIDU_API_KEY"),
...
def resolve_provider(
    ...
    *,
    ...
    _PROVIDER_ALIASES = {
        ...
        "baidu": "baidu-coding", "qianfan": "baidu-coding",
        "baidu-coding-plan": "baidu-coding",
        "baidu-qianfan": "baidu-coding", "baidu_qianfan": "baidu-coding",
