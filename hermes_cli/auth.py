...
def resolve_provider(
    ...
    *,
    ...
    _PROVIDER_ALIASES = {
        ...
        "qwen-portal": "qwen-oauth", "qwen-cli": "qwen-oauth", "qwen-oauth": "qwen-oauth", "google-gemini-cli": "gemini", "gemini-cli": "gemini", "gemini-oauth": "gemini",
...
def get_auth_status(provider_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    target = resolve_provider(provider_id or get_active_provider())
    if target == "spotify":
