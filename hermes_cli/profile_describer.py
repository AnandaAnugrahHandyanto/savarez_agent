...
Used by ``savarez profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Savarez AI Agent kanban board.
...
Rules:
  ...
  - Never write "Savarez AI Agent profile" or other meta-narration.
