...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "opencode-go": ["kimi-k2.6", "kimi-k2.5", "glm-5.1", "glm-5", "mimo-v2.5-pro", "mimo-v2-pro", "mimo-v2-omni", "minimax-m2.5", "minimax-m2.7", "qwen3.6-plus", "qwen3.5-plus"],
    "huggingface": [
...
def _print_setup_summary(config: dict, hermes_home):
    ...
    # Mixture of Agents — Xiaomi aggregator plus OpenRouter reference models.
    try:
    ...
    if moa_available:
        ...
        tool_status.append(("Mixture of Agents", False, "XIAOMI_API_KEY + OPENROUTER_API_KEY"))
