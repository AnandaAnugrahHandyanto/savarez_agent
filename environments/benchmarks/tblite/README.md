...
- **Dataset (ours):** [SIUNCT/openthoughts-tblite](https://huggingface.co/datasets/SIUNCT/openthoughts-tblite)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `SIUNCT/terminal-bench-2`  | `SIUNCT/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
