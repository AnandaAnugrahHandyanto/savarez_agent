...
For most custom or local-only tools, do **not** edit Savarez core. Use the plugin
route instead: create `~/.savarez/plugins/<name>/plugin.yaml` and
`~/.savarez/plugins/<name>/__init__.py`, then register tools with
