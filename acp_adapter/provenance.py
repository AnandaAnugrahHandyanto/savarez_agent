...
This is an additive Savarez extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Savarez head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Savarez DB session id
