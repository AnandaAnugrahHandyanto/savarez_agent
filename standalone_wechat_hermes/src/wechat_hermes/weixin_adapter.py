...
from wechat_hermes.helpers import MessageDeduplicator
from wechat_hermes.base_platform import (
    BasePlatformAdapter,
    MessageEvent,
    MessageType,
    SendResult,
...
from wechat_hermes.hermes_home import get_hermes_home
from wechat_hermes.atomic_json import atomic_json_write
...
class WeixinAdapter(BasePlatformAdapter):
    ...
    async def _download_remote_media(self, url: str) -> str:
        from wechat_hermes.url_safety import is_safe_url
