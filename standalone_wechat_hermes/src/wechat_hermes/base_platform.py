...
from wechat_hermes.utils_shim import normalize_proxy_url
...
from wechat_hermes.gateway_session import SessionSource, build_session_key
from wechat_hermes.hermes_home import get_hermes_dir
...
class BasePlatformAdapter(ABC):
    ...
    def _mark_connected(self) -> None:
        ...
        self._fatal_error_retryable = True
        try:
            from wechat_hermes.minimal_status import write_runtime_status
    ...
    def _acquire_platform_lock(self, scope: str, identity: str, resource_desc: str) -> bool:
        ...
        from wechat_hermes.minimal_status import acquire_scoped_lock
    ...
    def _release_platform_lock(self) -> None:
        ...
        if not identity:
            return
        from wechat_hermes.minimal_status import release_scoped_lock
    ...
    async def handle_message(self, event: MessageEvent) -> None:
        ...
        if session_key in self._active_sessions:
            ...
            def _should_bypass_active_session(cmd_name: str | None) -> bool:
                """Minimal slash-command bypass list (standalone; no full COMMAND_REGISTRY)."""
                if not cmd_name:
                    return False
                return cmd_name.lower() in {
                    "stop", "new", "reset", "help", "commands", "model",
                    "approve", "deny", "yes", "no",
                }

            if _should_bypass_active_session(cmd):
                logger.debug(
    ...
    async def _process_message_background(self, event: MessageEvent, session_key: str) -> None:
        ...
        try:
            ...
            if response:
                ...
                # Auto-TTS (full Hermes) not included in this standalone package.
