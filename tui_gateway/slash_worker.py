"""Persistent slash-command worker — one SavarezCLI per TUI session.
...
def _run(cli: SavarezCLI, command: str) -> str:
...
def main():
    ...
    with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(io.StringIO()):
        cli = SavarezCLI(model=args.model or None, compact=True, resume=args.session_key, verbose=False)
