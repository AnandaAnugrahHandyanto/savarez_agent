...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Savarez Teal",
  description: "Classic dark teal — the canonical Savarez look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Savarez look, ported from the
 ...
 * nousnet-web's <body> is white; savarez-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Savarez Teal (Large)",
  description: "Savarez Teal with bigger fonts and roomier spacing",
