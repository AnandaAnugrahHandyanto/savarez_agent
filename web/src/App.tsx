...
import GlassChatPage from "@/pages/GlassChatPage";
...
export default function App() {
  ...
  return (
    <div
      ...
      className="font-mondwest flex h-dvh max-h-dvh min-h-0 flex-col overflow-hidden bg-background-base uppercase text-midground antialiased"
    >
      <SelectionSwitcher />
      <Backdrop />
