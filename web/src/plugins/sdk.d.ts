/**
 * Savarez Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 ...
 *
 * Versioning: bump ``SavarezPluginSDK["sdkVersion"]`` (and the
...
export interface SavarezPluginSDK {
...
declare global {
  interface Window {
    __HERMES_PLUGIN_SDK__?: SavarezPluginSDK;
