...
export const zh: Translations = {
  ...
  achievements: {
    kicker: "智能代理积分",
    title: "Hermes 成就",
    subtitle: "从真实会话历史中获得的 Hermes 可收集徽章。已知的未完成成就显示为已发现；秘密成就隐藏在首次匹配行为出现之前。",
    loadingSubtitle: "正在扫描 Hermes 会话历史。首次扫描在大型历史上可能需要 5-10 秒。",
    buildingProfile: "正在构建成就档案…",
    readingData: "正在读取会话、工具调用、模型元数据和解锁状态。",
    rescan: "重新扫描",
    unlocked: "已解锁",
    discovered: "已发现",
    secrets: "秘密",
    ...
    latest: "最新",
    earnedBadges: "已获得的徽章",
    knownNotEarned: "已知，尚未获得",
    hiddenUntilSignal: "隐藏直到首次触发",
    tierOrder: "铜 → 银 → 金 → 钻石 → 奥林匹亚",
    noneYet: "暂无",
    ...
    buildingAchievementProfile: "正在构建成就档案…",
    scannedSessions: "已扫描 {scanned} / {total} 个会话 · {pct}%。随着更多历史数据流入，徽章将逐步解锁。",
    scanDetailNoTotal: "正在读取会话、工具调用、模型元数据和解锁状态。徽章解锁后将显示在这里。",
    tiers: "等级",
    secretAchievements: "秘密成就",
    secretDescription: "秘密成就隐藏其确切触发条件。一旦 Hermes 检测到相关信号，卡片将变为已发现状态并显示其要求。",
    scanStatus: "扫描状态",
    scanStatusDescription: "Hermes 正在一次性扫描本地历史，然后卡片将自动出现。如果这需要几秒钟，不必担心卡住。",
    whatIsScanned: "扫描内容",
    whatIsScannedDescription: "会话、工具调用、模型元数据、错误、成就和本地解锁状态。",
    all: "全部",
    filterAll: "全部",
    filterUnlocked: "已解锁",
    filterDiscovered: "已发现",
    filterSecret: "秘密",
    recentUnlocks: "最近解锁",
    noHiddenSecrets: "本次扫描中已无隐藏的秘密。",
    secretClue: "提示：秘密成就通常源自异常故障或高级用户模式 — 端口冲突、权限壁垒、缺失的环境变量、YAML 错误、Docker 冲突、回滚/检查点使用、缓存命中，或大量红色文字后的微小修复。",
    shareTitle: "分享：{name}",
    close: "关闭",
    rendering: "正在渲染…",
    somethingWentWrong: "出了点问题。",
    shareOnX: "分享到 X",
    shareOnXTitle: "在 X 中打开预填充的帖子",
    copyImage: "复制图片",
    copyImageTitle: "复制图片以粘贴到您的帖子中",
    copied: "已复制 ✓",
    downloadPNG: "下载 PNG",
    shareHint: "分享到 X 会在新标签页中打开预填充的帖子。如果您想附加 1200×630 的徽章图片，请先点击复制图片 — X 允许您直接将其粘贴到推文编辑器中。下载 PNG 可将文件保存到任意位置使用。",
    tweetText: '刚刚解锁了 {tier}"{name}" in Hermes Agent ☤\n\n@NousResearch · https://hermes-agent.nousresearch.com',
    clipboardNotSupported: "此浏览器不支持剪贴板图片复制 — 请改用下载。",
    achievementFallback: "成就",
    tierSuffix: " 等级",
    footerWatermark: "HERMES AGENT  ·  hermes-agent.nousresearch.com",
    unlockedStamp: "◆ 已解锁",
    canvasError: "canvas.toBlob 返回 null",
    tierCopper: "铜",
    tierSilver: "银",
    tierGold: "金",
    tierDiamond: "钻石",
