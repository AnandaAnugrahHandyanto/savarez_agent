...
export const zh: Translations = {
  ...
  status: {
    ...
    disconnected: "已断开",
    dashboard: "Dashboard",
    dashboardPeers: "其他 Dashboard 进程",
    stopPeer: "停止进程",
    stopPeerFailed: "停止 Dashboard 进程失败",
    stopPeerSucceeded: "Dashboard 进程已停止",
    error: "错误",
    failed: "失败",
    gateway: "网关",
  ...
  operations: {
    ...
    routerExplanation: "路由说明",
    stabilityStats: "稳定性统计",
    advisoryOnly: "仅作参考",
    suggestionOnly: "仅作建议",
    enabled: "已启用",
    disabled: "已禁用",
  ...
  // ── v2.10 多入口 ──
  v210: {
    contextTitle: "v2.10 会话上下文",
    mode: "模式",
    modeCliLegacy: "CLI 模式",
    modeMultiEntry: "多入口模式",
    modeCliLegacyDesc: "未注册外部适配器，系统处于纯 CLI 模式。",
    workspaces: "工作区",
    sessions: "会话",
    adapters: "适配器",
    adapterHealthTitle: "适配器健康",
    loadError: "加载适配器健康信息失败：",
    statusConnected: "已连接",
