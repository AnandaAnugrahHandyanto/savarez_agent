...
export const zh: Translations = {
  ...
  chat: {
    ...
    creatingSession: "创建中...",
    noSessions: "还没有聊天会话",
    noSessionsHint: "新建一个会话，开始和 Hermes 对话。",
    noMatchingSessions: "没有匹配的会话",
    noMatchingSessionsHint: "试试不同的标题、预览内容或会话 ID。",
    untitledSession: "未命名聊天",
    liveConversation: "实时对话",
    sessionId: "会话 ID",
    selectOrCreate: "选择一个会话或新建一个",
    ...
    emptyState: "发送一条消息，开始和 Hermes 对话",
    emptyStateHint: "你可以提问、粘贴任务，或用一句简短提示开场。",
    ...
    dismissError: "关闭",
    sendFailed: "消息发送失败",
    hotkeysHint: "Enter 发送 • Shift+Enter 换行 • / 或 Ctrl+K 聚焦 • Esc 清除错误",
    openHelpMenu: "打开命令菜单",
    closeHelpMenu: "关闭命令菜单",
    helpMenuTitle: "命令菜单",
    helpMenuDescription: "这里汇总了本聊天的命令、快捷键和快速操作。",
    commandsMenuShow: "命令",
    commandsMenuHide: "隐藏",
    helpNewLine: "Shift+Enter — 换行",
    helpFocus: "/ 或 Ctrl+K — 聚焦到消息输入框",
    helpDismissError: "Esc — 关闭当前错误",
    helpNewSession: "新建会话 — 开始新的对话",
    helpStopGeneration: "停止 — 中断当前回复",
    helpCopySession: "复制会话 ID — 复制当前聊天标识",
    sessionCopied: "会话 ID 已复制",
    sessionCopyFailed: "无法复制会话 ID",
    copyMessage: "复制",
    messageCopied: "消息已复制",
