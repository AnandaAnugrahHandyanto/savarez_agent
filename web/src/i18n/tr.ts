...
export const tr: Translations = {
  ...
  cron: {
    ...
    deliveryHint: "local, telegram, discord, signal, email veya platform:chat_id",
    skills: "Yetenekler",
    skillsPlaceholder: "her satıra bir yetenek",
    script: "Betik",
    scriptPlaceholder: "~/.hermes/scripts/ içine göre göreli",
    ...
    contextFromPlaceholder: "her satıra bir görev ID'si",
    enabledToolsets: "Etkin araç setleri",
    enabledToolsetsPlaceholder: "her satıra bir araç seti",
    errors: {
