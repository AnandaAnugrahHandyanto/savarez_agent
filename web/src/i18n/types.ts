...
export interface Translations {
  ...
  achievements: {
    ...
    latest: string;
    earnedBadges: string;
    knownNotEarned: string;
    hiddenUntilSignal: string;
    tierOrder: string;
    noneYet: string;
    runHermesMore: string;
    ...
    whatCounts: string;
    startingScan: string;
    buildingAchievementProfile: string;
    scannedSessions: string;
    scanDetailNoTotal: string;
    tiers: string;
    secretAchievements: string;
    secretDescription: string;
    scanStatus: string;
    scanStatusDescription: string;
    whatIsScanned: string;
    whatIsScannedDescription: string;
    all: string;
    filterAll: string;
