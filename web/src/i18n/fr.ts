...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateSavarez: "Mettre à jour Savarez",
    updatingSavarez: "Mise à jour de Savarez…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Savarez (parité avec `savarez plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.savarez/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.savarez/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.savarez/skills/",
  ...
  config: {
    configPath: "~/.savarez/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  achievements: {
    hero: {
      ...
      title: "Savarez Achievements",
      subtitle:
        "Badges Savarez à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Savarez en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Savarez davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Savarez détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Savarez analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Savarez AI Agent ☤",
    },
  },
  kanban: {
