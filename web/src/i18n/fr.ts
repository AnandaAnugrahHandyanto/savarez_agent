...
export const fr: Translations = {
  ...
  oauth: {
    ...
    detectedMethod: "Detected OAuth authentication: {method}",
    notConnectedBadge: "Not connected",
    preAuthDescription: "{provider} uses OAuth authentication. Hermes will prepare a short-lived authorization session only after you click Authenticate.",
    preAuthStep1: "Click Authenticate to start the OAuth flow.",
    preAuthStep2: "Hermes opens the provider page in a new browser tab.",
    preAuthStep3: "Authorize there, then return here to finish the connection.",
