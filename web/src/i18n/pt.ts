...
export const pt: Translations = {
  ...
  cron: {
    ...
    deliveryHint: "local, telegram, discord, signal, email, or platform:chat_id",
    skills: "Skills",
    skillsPlaceholder: "one skill per line",
    script: "Script",
    scriptPlaceholder: "relative to ~/.hermes/scripts/",
    workdir: "Workdir",
    ...
    enabledToolsetsPlaceholder: "one toolset per line",
    errors: {
