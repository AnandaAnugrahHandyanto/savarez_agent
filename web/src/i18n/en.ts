...
export const en: Translations = {
  ...
  channelsPage: {
    connected: "Connected", restartToApply: "Restart to apply", gatewayStopped: "Gateway stopped",
    disconnected: "Disconnected", notConfigured: "Not configured", disabled: "Disabled",
    error: "Error", expired: "expired", nothingToSave: "Nothing to save — fill in at least one field.",
    required: "is required", saved: "saved", saveFailed: "Failed to save",
    gatewayRestarting: "Gateway restarting…", restartFailed: "Failed to restart",
    restarting: "Restarting…", restartGateway: "Restart gateway",
    changesSaved: "Changes are saved. Restart the gateway for them to take effect.",
    restartNow: "Restart now",
    gatewayNotRunning: "The gateway is not running. Configure channels here, then start the gateway with",
    configuredCount: "{configured} of {total} channels configured. Credentials are written to",
    close: "Close", configure: "Configure", setupGuide: "Setup guide",
    keepExisting: "•••••• (set — leave blank to keep)", cancel: "Cancel",
    saving: "Saving…", saveEnable: "Save & enable", enable: "Enable", test: "Test",
    ...
    starting: "Starting…", setupQr: "Set up with QR",
    telegramConfigured: "Existing Telegram credentials are configured.",
    ready: "Ready", allowedUsers: "Allowed users", ownerDetected: "owner detected",
    telegramId: "Telegram user ID", add: "Add", saveRestart: "Save and restart",
    qrAlt: "Telegram setup QR code", waiting: "waiting", openTelegram: "Open Telegram",
  },

  webhooksPage: {
    copy: "Copy", loadFailed: "Failed to load webhooks", gatewayRestarting: "Gateway restarting…",
    restartFailedExit: "Gateway restart failed with exit {code}.",
    restartManually: "Gateway restart failed — restart manually",
    webhooksEnabledRestarting: "Webhooks enabled; gateway restarting…",
    gatewayRestartFailed: "Gateway restart failed", enableFailed: "Failed to enable webhooks",
    nameRequired: "Name required", created: "Created", createFailed: "Failed to create",
    enabled: "Enabled", disabled: "Disabled", error: "Error", deleted: "Deleted",
    newSubscription: "New subscription", deleteWebhook: "Delete webhook",
    ...
    close: "Close",
    createdDescription: "Subscription created. Copy the secret now — it is only shown once.",
    webhookUrl: "Webhook URL", secretOnce: "Secret (shown once)", done: "Done",
    name: "Name", namePlaceholder: "e.g. github-push", description: "Description",
    descriptionPlaceholder: "What this webhook does (optional)", events: "Events",
    eventsPlaceholder: "comma-separated, leave empty for all", deliverTo: "Deliver to",
    log: "Log", telegram: "Telegram", discord: "Discord", slack: "Slack", email: "Email",
    githubComment: "GitHub comment", deliverOnly: "Deliver only",
    deliverOnlyDescription: "Skip the agent, deliver payload directly", prompt: "Prompt",
    promptPlaceholder: "Instructions for the agent when this webhook fires (optional)",
    creating: "Creating…", create: "Create", receiverDisabled: "Webhook receiver disabled",
    receiverDescription: "Webhooks are their own gateway platform. Enable them here to accept incoming HTTP events; chat channels are only needed when a subscription delivers to another channel.",
    enabling: "Enabling…", enableWebhooks: "Enable webhooks",
    restartRequired: "Webhooks are enabled, but the gateway still needs a restart before the receiver can come online.",
    restarting: "Restarting…", restartGateway: "Restart gateway",
    subscriptions: "Subscriptions ({count})",
    subscriptionsDescription: "Subscription changes hot-reload once the webhook receiver is running. Disabled subscriptions reject incoming events.",
    noSubscriptions: "No webhook subscriptions yet.", deliverOnlyBadge: "deliver only",
    disabledBadge: "disabled", all: "(all)", disable: "Disable", enable: "Enable", delete: "Delete",
  },
