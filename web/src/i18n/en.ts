...
export const en: Translations = {
  ...
  status: {
    ...
    dashboard: "Dashboard",
    dashboardPeers: "Other dashboard processes",
    stopPeer: "Stop peer",
    stopPeerFailed: "Failed to stop dashboard peer",
    stopPeerSucceeded: "Dashboard peer stopped",
    error: "Error",
    failed: "Failed",
    gateway: "Gateway",
  ...
  runs: {
    ...
    noAttention: "No task needs attention right now",
  },
  ...
  operations: {
    ...
    queueAndScheduler: "Queue And Scheduler",
    scheduler: "Scheduler",
    queue: "Queue",
    watchdog: "Watchdog",
    ...
    routerExplanation: "Router Explanation",
    stabilityStats: "Stability Stats",
  ...
  // ── v2.10 Multi-Entry ──
  v210: {
    contextTitle: "v2.10 Context",
    mode: "Mode",
    modeCliLegacy: "CLI Legacy",
    modeMultiEntry: "Multi-Entry",
    modeCliLegacyDesc: "No external adapters registered. System is in CLI-only legacy mode.",
    workspaces: "Workspaces",
    sessions: "Sessions",
    adapters: "Adapters",
    adapterHealthTitle: "Adapter Health",
    loadError: "Failed to load adapter health: ",
