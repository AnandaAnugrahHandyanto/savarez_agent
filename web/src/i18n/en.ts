...
export const en: Translations = {
  ...
  chat: {
    ...
    noSessionsHint: "Create a new session to start talking with Hermes.",
    noMatchingSessions: "No sessions match your search",
    noMatchingSessionsHint: "Try a different title, preview snippet, or session ID.",
    untitledSession: "Untitled chat",
    liveConversation: "Live conversation",
    sessionId: "Session ID",
    selectOrCreate: "Select a session or start a new one",
    ...
    emptyState: "Send a message to begin talking with Hermes",
    emptyStateHint: "Ask a question, paste a task, or start with a short prompt.",
    inputPlaceholder: "Type a message...",
    sending: "Sending...",
    send: "Send",
    typing: "Hermes is typing…",
    jumpToLatest: "Latest",
    retry: "Retry",
    dismissError: "Dismiss",
    sendFailed: "Message failed",
    hotkeysHint: "Enter to send • Shift+Enter for newline • / or Ctrl+K to focus • Esc clears errors",
    openHelpMenu: "Open commands menu",
    closeHelpMenu: "Close commands menu",
    helpMenuTitle: "Commands menu",
    helpMenuDescription: "Commands, shortcuts, and quick actions for this chat.",
    commandsMenuShow: "Commands",
    commandsMenuHide: "Hide",
    helpNewLine: "Shift+Enter — add a new line",
    helpFocus: "/ or Ctrl+K — focus the message field",
    helpDismissError: "Esc — hide the current error",
    helpNewSession: "New session — start a fresh chat",
    helpStopGeneration: "Stop — interrupt the current reply",
    helpCopySession: "Copy session ID — copy the active chat ID",
    sessionCopied: "Session ID copied",
    sessionCopyFailed: "Could not copy session ID",
    copyMessage: "Copy",
    messageCopied: "Message copied",
    messageCopyFailed: "Could not copy message",
    stopGenerating: "Stop",
