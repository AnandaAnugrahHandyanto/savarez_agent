...
export const en: Translations = {
  ...
  dashboard: {
    ...
    models: {
      ...
      override: "override",
      overrides: "overrides",
      tasksAllAuto: "{count} tasks · all auto",
      tasksAuto: "{count} tasks · {auto} auto",
      auxiliarySummaryWithOverrides: "{overrides} overrides · {auto} auto",
      useAs: "Use as",
      ...
      tokenAnalyticsShort:
        "Token & cost analytics are hidden because local counts exclude auxiliary calls and provider retries. Enable dashboard.show_token_analytics in Config to show the local debug estimate.",
      tokenAnalyticsHiddenTitle: "Token analytics hidden",
      tokenAnalyticsHiddenP1:
        "The token, cost, and per-day analytics on this page are a local debug estimate. They only count successful main-agent responses with a usable usage block, and silently exclude auxiliary calls plus provider-side retries and fallback attempts. Cache writes are missing entirely.",
      tokenAnalyticsHiddenP2:
        "On models with heavy auxiliary traffic, the local total can be 10x–100x lower than what your provider bills. Hiding these numbers is safer than letting them look authoritative.",
      tokenAnalyticsHiddenP3:
        "Check your provider dashboard for actual usage and billing. To re-enable the local debug estimate anyway, set dashboard.show_token_analytics: true in Config.",
      configLink: "Config",
