...
export const en: Translations = {
  ...
  achievements: {
    ...
    readingData: "Reading sessions, tool calls, model metadata, and unlock state.",
    rescan: "Rescan",
    unlocked: "Unlocked",
    ...
    tierOrder: "Copper → Silver → Gold → Diamond → Olympian",
    noneYet: "None yet",
    ...
    buildingAchievementProfile: "Building achievement profile…",
    scannedSessions:
    ...
    noHiddenSecrets: "No hidden secrets left in this scan.",
    secretClue:
    ...
    shareOnX: "Share on X",
    shareOnXTitle: "Opens X with a pre-filled post",
    copyImage: "Copy image",
    copyImageTitle: "Copy the image to paste into your post",
    copied: "Copied ✓",
    ...
    tweetText:
      'Just unlocked {tier}"{name}" in Hermes Agent ☤\n\n@NousResearch · https://hermes-agent.nousresearch.com',
    clipboardNotSupported:
      "Clipboard image copy not supported in this browser — use Download instead.",
    achievementFallback: "Achievement",
    tierSuffix: " TIER",
    footerWatermark: "HERMES AGENT  ·  hermes-agent.nousresearch.com",
    unlockedStamp: "◆ UNLOCKED",
    canvasError: "canvas.toBlob returned null",
    tierCopper: "Copper",
    tierSilver: "Silver",
    tierGold: "Gold",
    tierDiamond: "Diamond",
    tierOlympian: "Olympian",
  },
};
