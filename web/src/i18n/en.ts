...
export const en: Translations = {
  ...
  profiles: {
    ...
    skills: "Skills",
    rename: "Rename",
    editSoul: "Edit profile SOUL.md",
    soulSection: "Profile SOUL.md (agent identity, not universal AGENTS.md policy)",
    soulPlaceholder: "# How this specific profile should behave…",
    saveSoul: "Save SOUL",
