...
export const en: Translations = {
  ...
  profiles: {
    ...
    cloneFromNone: "(blank profile)",
    cloneMode: "Clone mode",
    cloneModeNone: "Don't clone",
    cloneModeConfig: "Config only",
    cloneModeAll: "All state",
    importTitle: "Import Profile",
    importAction: "Import",
    archivePath: "Archive path (server-side)",
    archivePathPlaceholder: "/path/to/profile.tar.gz",
    archivePathRequired: "Archive path is required",
    importNameOptional: "Target name (optional)",
    importNamePlaceholder: "Defaults to archive's top-level dir",
    allProfiles: "Profiles",
    noProfiles: "No profiles found.",
    onlyDefaultHint:
      "Only the default profile exists. Create one above to manage isolated agent state.",
    defaultBadge: "default",
    activeBadge: "active",
    gatewayRunning: "gateway up",
    hasEnv: "env",
    model: "Model",
    skills: "Skills",
    restartGateway: "Restart gateway",
