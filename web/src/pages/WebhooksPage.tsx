  ...
  const handleToggleEnabled = useCallback(
    async (subName: string, nextEnabled: boolean) => {
      ...
      try {
        ...
        showToast(
          `${nextEnabled ? copy.enabled : copy.disabled}: «${subName}»`,
          "success",
        );
        loadWebhooks();
      } catch (e) {
    ...
    [copy.disabled, copy.enabled, copy.error, loadWebhooks, showToast],
  );
    ...
    onDelete: useCallback(
      async (name: string) => {
        try {
          ...
          showToast(`${copy.deleted}: «${name}»`, "success");
          loadWebhooks();
        } catch (e) {
          showToast(`${copy.error}: ${e}`, "error");
          throw e;
      ...
      [copy.deleted, copy.error, loadWebhooks, showToast],
    ),
  });
