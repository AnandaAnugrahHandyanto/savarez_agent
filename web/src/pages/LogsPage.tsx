      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">日誌</CardTitle>
              {loading && (
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                />
                <Label className="text-xs">自動更新</Label>
                {autoRefresh && (
        ...
        <CardContent>
          <div className="flex flex-col gap-3 mb-4">
            <FilterBar label="檔案" options={FILES} value={file} onChange={setFile} />
            <FilterBar label="等級" options={LEVELS} value={level} onChange={setLevel} />
            <FilterBar label="元件" options={COMPONENTS} value={component} onChange={setComponent} />
            <FilterBar
              label="行數"
          ...
          >
            {lines.length === 0 && !loading && (
              <p className="text-muted-foreground text-center py-8">目前沒有日誌內容</p>
            )}
            {lines.map((line, i) => {
