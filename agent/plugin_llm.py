...
Plugins built on Savarez AI Agent often need to make their own LLM calls
...
Today the only stable plugin surfaces extend an existing Savarez
...
embedded slugs, no shorthands. This mirrors Savarez' main config
...
handles every provider, fallback chain, and per-task override Savarez
supports.
"""
