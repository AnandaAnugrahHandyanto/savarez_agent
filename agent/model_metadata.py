...
def _query_local_context_length(model: str, base_url: str, api_key: str = "") -> Optional[int]:
    ...
    try:
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            # Skip when server_type is None (unknown server, e.g. LiteLLM proxy)
            # because this endpoint is admin-gated and the /v1/models list call
            # below works universally on all OpenAI-compatible servers.
