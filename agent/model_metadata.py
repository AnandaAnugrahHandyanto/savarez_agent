...
_PROVIDER_PREFIXES: frozenset[str] = frozenset({
    ...
    "volcano", "volcano-engine", "volcengine-api", "volcengine-standard",
    "volcengine_coding_plan", "volcengine-coding", "volcengine_coding",
    "volcano-coding-plan", "volcano_coding_plan",
    "byteplus-api", "byteplus-standard", "byteplus_coding_plan",
