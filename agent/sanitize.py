"""Text sanitization utilities for JSON compatibility and encoding safety.

Extracted from run_agent.py to improve maintainability. These functions handle
surrogate codepoint removal and non-ASCII stripping for systems with limited
encoding support.
"""
...
# Pre-compiled regex for UTF-16 surrogate code points (U+D800-U+DFFF).
# These are invalid in UTF-8 and will crash json.dumps() inside the OpenAI SDK.
...
def sanitize_structure_non_ascii(payload: Any) -> bool:
