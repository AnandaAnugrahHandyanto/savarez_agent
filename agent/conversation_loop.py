...
from hermes_constants import PARTIAL_STREAM_STUB_ID, parse_reasoning_effort
...
def run_conversation(
    ...
    if final_response is None and (
        ...
        #
        # Build rich recovery handoff, then route the actual failure through
        # _record_task_failure(outcome="timed_out") so consecutive_failures
        # increments and the dispatcher's failure_limit circuit breaker works.
