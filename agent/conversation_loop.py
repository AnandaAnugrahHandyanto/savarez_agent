            ...
            try:
                ...
                if is_context_length_error:
                    ...
                    if new_ctx is not None:
                        ...
                        agent._vprint(f"{agent.log_prefix}⚠️  Context length exceeded — using provider limit: {old_ctx:,} → {new_ctx:,} tokens", force=True)
                        ...
                        agent._vprint(
                            f"{agent.log_prefix}⚠️  Context length exceeded, but provider did not report a max context length; "
                            f"keeping context_length at {old_ctx:,} tokens and compressing.",
                            force=True,
                        )
