...
Supported languages: en, zh, ja, de, es, fr, tr, uk, id.  Unknown values fall back to en.
"""
...
_LANGUAGE_ALIASES: dict[str, str] = {
    ...
    "indonesian": "id", "indonesia": "id", "bahasa": "id",
    "bahasa indonesia": "id",
    "bahasa-indonesia": "id", "bahasa_indonesia": "id", "id-id": "id",
}
