...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if agent._memory_store and not getattr(agent, "_suppress_memory_prompt", False):
    ...
    if agent._memory_manager and not getattr(agent, "_suppress_memory_prompt", False):
        try:
