...
projection into Savarez' display, approval bridging, transcript projection into
...
"codex_app_server"`. Savarez' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
        ...
        if spawn_env.get("HERMES_KANBAN_TASK"):
            ...
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "HERMES_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("SAVAREZ_HOME", os.path.expanduser("~/.savarez")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "savarez",
        client_title: str = "Savarez AI Agent",
