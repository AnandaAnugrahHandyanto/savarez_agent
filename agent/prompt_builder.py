...
KANBAN_GUIDANCE = (
    ...
    "`kanban_complete(summary=\"review-required: <one-line summary>\", "
    "metadata={\"handoff\": \"review-required\"})`. If a reviewer child task "
    "exists (created by orchestrator), it auto-promotes to ready. "
    "Never use `kanban_block(\"review-required\")` — it freezes ALL child "
    "tasks and causes DAG deadlock (2026-06-18 verified).\n"
