...
ADVISOR_GUIDANCE = (
    ...
    "just read, you don't need to keep calling — the advisor adds most of "
    "its value on the first call, before the approach crystallizes.\n\n"
    ...
    "surface the conflict in one more advisor call — 'I found X, you "
    "suggest Y, which constraint breaks the tie?' The advisor saw your "
    "evidence but may have underweighted it; a reconcile call is cheaper "
