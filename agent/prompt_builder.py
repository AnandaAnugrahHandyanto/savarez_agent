...
KANBAN_GUIDANCE = (
    ...
    "`файлы созданы`, `тесты запущены`. "
    "During long subprocesses (training, encoding, crawling, installs, large test "
    "runs), call it every 2–5 minutes with a short human-readable progress note. "
    "Skip only truly tiny tasks that finish in one or two tool calls.\n"
