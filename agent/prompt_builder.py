...
KANBAN_GUIDANCE = (
    ...
    "eyes on it.\n"
    "Repository code-change tasks have an additional gate: branch, commit, "
    "push, and open a PR; do not merge or enable auto-merge. Only after "
    ...
    "The reviewer completes with a verdict or blocks with required changes. "
    "The final merge decision belongs to the user, not the implementation "
    "worker and not the reviewer.\n"
