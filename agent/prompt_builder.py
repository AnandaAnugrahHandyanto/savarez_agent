...
KANBAN_GUIDANCE = (
    ...
    "7. **No circular remediation links.** If a reviewer/gate blocks because "
    "another specialist must fix something, create that remediation as runnable "
    "follow-up work; do not make it wait for the blocked gate itself. After the "
    "fix lands, an orchestrator should unblock/re-run the gate with the evidence.\n"
    "\n"
    "## Orchestrator mode\n"
    "\n"
