...
PLATFORM_HINTS = {
    ...
    "telegram": (
        ...
        "when presenting structured data; these degrade gracefully (tables "
        "become readable bullet groups) when rich rendering is unavailable, "
        "but advanced constructs like math and collapsible details may render "
        "as plain source text in that case. "
        "You can send media files natively: to deliver a file to the user, "
