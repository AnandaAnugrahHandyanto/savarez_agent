...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "Whenever a task involves a GitHub issue, PR, code review, QA verdict, or shipping "
            "claim and the `clawteam-operations` skill is available, load it first and treat "
            "`qa-validation` as the audit gate before any done/shipped/completion line.\n"
