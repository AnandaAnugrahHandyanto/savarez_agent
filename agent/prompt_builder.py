...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "This is a preflight step, not optional background reading: if the task involves "
            "integration work, setup, troubleshooting, third-party services, code generation, "
            "or repository/project changes, load the matching skill before inventing commands, "
            "writing code, or debugging from first principles. If no exact skill name is obvious "
            "but the task belongs to a listed category, call skills_list and/or load the closest "
            "umbrella skill first. "
            "Err on the side of loading — it is always better to have context you don't need "
            "than to miss critical steps, pitfalls, or established workflows. "
            "Skills contain specialized knowledge — API endpoints, tool-specific commands, "
            "and proven workflows that outperform general-purpose approaches. Load the skill "
            "even if you think you could handle the task with basic tools like web_search or terminal. "
            "Do not hand-roll integrations or custom listeners until you have loaded the relevant "
            "skill and verified that the documented/official path does not cover the need. "
