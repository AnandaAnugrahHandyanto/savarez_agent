...
COMPUTER_USE_GUIDANCE = (
    ...
    "2. Act by element index: `computer_use_click(element=14)`. This is "
    "dramatically more reliable than pixel coordinates for any model. "
    "Use raw coordinates only as a last resort.\n"
    "3. For text input, use `computer_use_type_text(text='...')`. For key "
    "combos use `computer_use_press_key(key='cmd+s')`. For scrolling use "
    "`computer_use_scroll(direction='down', amount=3)`.\n"
