...
COMPUTER_USE_GUIDANCE = (
    ...
    "2. Act by app + element index: `computer_use_click(app='Helium', element=14)`. "
    ...
    "`computer_use_type_text(app='Helium', text='...')`. For key combos use "
    "`computer_use_press_key(app='Helium', key='cmd+s')`. For scrolling use "
    "`computer_use_scroll(app='Helium', direction='down', pages=1)`.\n"
    ...
    "- Mutating tools should fail closed when `app` cannot be targeted. "
    "Do not silently operate on the frontmost random window.\n"
