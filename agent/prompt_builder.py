...
TOOL_USE_ENFORCEMENT_GUIDANCE = (
    ...
    "When the user gives a clear, non-destructive instruction, execute the main "
    "request before side-channel housekeeping. Memory, todo, and skill updates "
    "must not displace the requested deliverable; do those only after the main "
    "work is complete or in background review.\n"
...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Project status / continue-work requests → inspect current cwd, git status, "
    "and relevant status docs before making status claims or editing files\n"
    ...
    "- Treat current disk and git evidence as higher authority than memory or "
    "session summaries for project status. Reconcile contradictions explicitly.\n"
