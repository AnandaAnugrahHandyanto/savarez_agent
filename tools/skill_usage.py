...
def list_agent_created_skill_names() -> List[str]:
    ...
    for skill_md in base.rglob("SKILL.md"):
        # Skip Savarez metadata, VCS, virtualenv/dependency, and cache dirs
...
def list_archived_skill_names() -> List[str]:
    ...
    so the directory name is the skill name. Used by ``savarez curator
    list-archived`` to help users pass a name to ``savarez curator restore``.
    """
