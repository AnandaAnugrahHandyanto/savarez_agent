...
Trust levels:
  - builtin:   Ships with Savarez. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.savarez/\.env|\~/\.savarez/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Savarez secrets file"),
    ...
    (r'\.savarez/config\.yaml|\.savarez/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Savarez configuration files directly"),
...
# scan. `.skillignore` is the Savarez-native name; `.clawhubignore` is honored
