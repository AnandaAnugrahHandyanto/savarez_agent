...
One ``CDPSupervisor`` runs per Savarez ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "savarez-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http:/.savarez-dialog-bridge.invalid/";
