...
class TodoStore:
    ...
    def format_for_injection(self) -> Optional[str]:
        ...
        lines = [
            "[COMPACTION CONTINUATION CAPSULE — AUTHORITATIVE ROUTING]",
            "Generated by Hermes from the preserved todo store across context compression; this is not a user-authored chat request.",
            "Latest real user message after this capsule overrides it.",
            "Continue pending/in_progress items in order unless the user redirects.",
        ]
