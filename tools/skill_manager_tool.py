...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "or `absorbed_into=\"\"` when pruning with no target. "
        "The target must already exist — create/patch the umbrella first, then delete.\n\n"
        "IMPORTANT: Load the skill-management-guide skill for when to create/update "
        "skills, best practices, and pinned skill behavior."
    ),
    "parameters": {
        "type": "object",
        "properties": {
