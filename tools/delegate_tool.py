...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "- Standing consent: when a system reminder says orchestration mode is on, "
        "use delegate_task by default for substantive tasks after scouting the "
        "work-list; do not ask for separate permission unless the delegated work "
        "would cross safety/approval boundaries.\n\n"
