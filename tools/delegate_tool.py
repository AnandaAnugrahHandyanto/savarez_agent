...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        f"2. Batch (parallel): provide 'tasks' array, up to {_get_max_concurrent_children()} "
        f"run concurrently (delegation.max_concurrent_children, configurable via config.yaml); "
