...
def _build_child_system_prompt(
    ...
    *,
    ...
    # an explicit nudge, almost never call mcp_skills_list / mcp_skill_view
    ...
    parts.append(
        ...
        "`mcp_skills_list` (cheap, returns name+description only). "
        ...
        "`mcp_skill_view(name)` and follow its instructions.\n\n"
