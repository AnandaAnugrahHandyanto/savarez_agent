...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/savarez-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/savarez-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/savarez-results"
        ...
        if callable(get_temp_dir):
            try:
                ...
                if temp_dir:
                    ...
                    return f"{temp_dir}/savarez-results"
    return STORAGE_DIR
