...
try:
    ...
    registry.register_tool(
        ...
        toolset="agent",
        schema={
            "description": "OMC-style multi-agent orchestration with staged pipeline",
            "parameters": {
                "type": "object",
                "properties": {
                    "goal": {"type": "string"},
                    "mode": {"type": "string", "enum": ["team", "ccg", "autopilot", "ralph", "ultrawork"]},
                    "stages": {"type": "array", "items": {"type": "string"}},
                    "stage_agents": {"type": "object"},
        ...
        handler=staged_delegate,
        check_fn=_check_staged_delegate,
        description="OMC-style multi-agent orchestration",
        emoji="🎭",
    )
except ImportError:
...
def ada_delegate(
    ...
    try:
        result = unified_dev(goal, context, force_mode=force, mock=mock)
        return {
            "success": result.get("success", False),
    ...
    register_tool(
        ...
        schema={
            ...
            "parameters": {
                ...
                "properties": {
                    "goal": {"type": "string"},
                    "mode": {"type": "string", "enum": ["auto", "quick", "quick_plus", "full"]},
                    "context": {"type": "object"},
