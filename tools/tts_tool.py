...
- MiniMax TTS: High-quality with voice cloning, needs MINIMAX_TTS_API_KEY or MINIMAX_API_KEY
...
def _generate_minimax_tts(text: str, output_path: str, tts_config: Dict[str, Any]) -> str:
    ...
    api_key = (get_env_value("MINIMAX_TTS_API_KEY") or get_env_value("MINIMAX_API_KEY") or "")
    if not api_key:
        raise ValueError("Neither MINIMAX_TTS_API_KEY nor MINIMAX_API_KEY is set. "
...
def check_tts_requirements() -> bool:
    ...
    try:
        ...
        pass
    if get_env_value("MINIMAX_TTS_API_KEY") or get_env_value("MINIMAX_API_KEY"):
        return True
...
if __name__ == "__main__":
    ...
    print(f"  MiniMax:    {'API key set' if get_env_value('MINIMAX_TTS_API_KEY') or get_env_value('MINIMAX_API_KEY') else 'not set (MINIMAX_TTS_API_KEY or MINIMAX_API_KEY)'}")
