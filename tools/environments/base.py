"""Base class for all Savarez execution environment backends.
...
def get_sandbox_dir() -> Path:
    ...
    Configurable via TERMINAL_SANDBOX_DIR. Defaults to {SAVAREZ_HOME}/sandboxes/.
    """
...
class BaseEnvironment(ABC):
    """Common interface and unified execution flow for all Savarez backends.
    ...
    def __init__(self, cwd: str, timeout: int, env: dict = None):
        ...
        self._snapshot_path = f"{temp_dir}/savarez-snap-{self._session_id}.sh"
        self._cwd_file = f"{temp_dir}/savarez-cwd-{self._session_id}.txt"
    ...
    def init_session(self):
        ...
        # caused ``C:/Users/.../savarez-snap-*.sh: No such file or directory``
