...
Limitations:
  - DNS rebinding (TOCTOU): an attacker-controlled DNS server with TTL=0
    ...
    agent. Preventing the first packet still requires connection-level control
    such as Python's Champion library for Python clients or an egress proxy
    like Stripe's Smokescreen.
